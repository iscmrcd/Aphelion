...
import { META_ADS_TIJUANA } from "@/lib/local-data";

const page = META_ADS_TIJUANA;

export const Route = createFileRoute("/meta-ads-tijuana")({
        ...
        },
        {
          ...
          itemListElement: [
            { "@type": "ListItem", position: 1, name: "Aphelion", item: SITE_URL },
            {
              ...
              position: 2,
              name: lang === "es" ? page.h1Es : page.h1,
              item: `${SITE_URL}/meta-ads-tijuana`,
            },
          ],
        },
      ],
