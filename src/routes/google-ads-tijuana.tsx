...
import { GOOGLE_ADS_TIJUANA } from "@/lib/local-data";

const page = GOOGLE_ADS_TIJUANA;

export const Route = createFileRoute("/google-ads-tijuana")({
    ...
    return buildHead({
      ...
      jsonLd: [
        ORGANIZATION_JSONLD,
        {
          ...
          url: `${SITE_URL}/google-ads-tijuana`,
        },
        {
          "@type": "FAQPage",
        ...
        },
        {
          ...
          itemListElement: [
            { "@type": "ListItem", position: 1, name: "Aphelion", item: SITE_URL },
            {
              ...
              position: 2,
              name: lang === "es" ? page.h1Es : page.h1,
              item: `${SITE_URL}/google-ads-tijuana`,
            },
          ],
        },
      ],
...
function Page() {
  return <LocalServicePage page={page} blogCategories={["Paid Ads", "Publicidad"]} />;
}
