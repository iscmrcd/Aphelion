...
import { TIJUANA_HUB } from "@/lib/local-data";

const page = TIJUANA_HUB;

export const Route = createFileRoute("/agencia-marketing-digital-tijuana")({
    ...
    return buildHead({
      ...
      jsonLd: [
        ORGANIZATION_JSONLD,
        {
          ...
          url: `${SITE_URL}/agencia-marketing-digital-tijuana`,
        },
        {
          "@type": "FAQPage",
        ...
        },
        {
          ...
          itemListElement: [
            { "@type": "ListItem", position: 1, name: "Aphelion", item: SITE_URL },
            {
              ...
              position: 2,
              name: lang === "es" ? page.h1Es : page.h1,
              item: `${SITE_URL}/agencia-marketing-digital-tijuana`,
            },
          ],
        },
      ],
...
function Page() {
  return (
    <LocalServicePage
      page={page}
      blogCategories={["Marketing Strategy", "Estrategia de Marketing"]}
    />
  );
}
