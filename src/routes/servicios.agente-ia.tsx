...
import ogImage from "@/assets/agente-ia-og.jpg.asset.json";

export const Route = createFileRoute("/servicios/agente-ia")({
  loaderDeps: ({ search }) => ({ lang: search.lang }),
  loader: ({ deps }) => deps,
  head: ({ loaderData }) =>
    buildHead({
      path: "/servicios/agente-ia",
      lang: loaderData?.lang ?? "en",
      en: {
        title: "AI Agent for Your Website | Aphelion",
        description:
          "An AI chat agent embedded on your site that answers, qualifies leads and books appointments. Try three live agents on this page before you decide.",
        ogTitle: "AI Agent — Aphelion",
        ogDescription:
          "Automated flows or a real conversational AI agent on your website. Try it live on the page, no signup.",
      },
      es: {
        title: "Agente de IA para tu Sitio Web | Aphelion",
        description:
          "Un agente de chat con IA integrado en tu sitio que responde, califica leads y agenda citas. Prueba tres agentes en vivo en esta página antes de decidir.",
        ogTitle: "Agente IA — Aphelion",
        ogDescription:
          "Flujos automatizados o un agente de IA conversacional real en tu sitio web. Pruébalo en vivo en la página, sin registro.",
      },
      ...
      jsonLd: [
        {
          "@type": "Service",
          serviceType: "Website chat automation and conversational AI agents",
        ...
        {
          "@type": "FAQPage",
          mainEntity: AGENTE_IA_FAQ.map((f) => ({
            "@type": "Question",
...
function AgenteIAPage() {
  ...
  return (
    <main className="min-h-screen bg-neutral-50 text-neutral-950 antialiased selection:bg-neutral-950 selection:text-white">
      <AiGradientDefs />
      {/* Hero */}
      <ScrollDrivenBanner variant="whatsapp" ariaLabel="Agente IA banner">
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-white/70 sm:text-lg">
            {t(
              "Automated flows for the predictable questions, or a real AI agent that understands, qualifies and books — living on your own site. This isn't a mockup: scroll down and talk to three live agents yourself.",
              "Flujos automatizados para las preguntas predecibles, o un agente de IA real que entiende, califica y agenda, viviendo en tu propio sitio. Esto no es un mockup: baja y platica tú mismo con tres agentes en vivo.",
            )}
          </p>
