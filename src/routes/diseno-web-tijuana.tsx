...
import { DISENO_WEB_TIJUANA } from "@/lib/local-data";

const page = DISENO_WEB_TIJUANA;

export const Route = createFileRoute("/diseno-web-tijuana")({
    ...
    return buildHead({
      ...
      jsonLd: [
        ORGANIZATION_JSONLD,
        {
          ...
          url: `${SITE_URL}/diseno-web-tijuana`,
        },
        {
          "@type": "FAQPage",
        ...
        },
        {
          ...
          itemListElement: [
            { "@type": "ListItem", position: 1, name: "Aphelion", item: SITE_URL },
            {
              ...
              position: 2,
              name: lang === "es" ? page.h1Es : page.h1,
              item: `${SITE_URL}/diseno-web-tijuana`,
            },
          ],
        },
      ],
...
function Page() {
  return <LocalServicePage page={page} blogCategories={["Web Design", "Diseño Web"]} />;
}
