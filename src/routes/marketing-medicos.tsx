...
function Page() {
  ...
  return (
    <main style={{ background: C.bg }}>
      {/* HERO — disarms the suspicion in the first screen */}
      <section className="px-5 pt-24 pb-16 sm:pt-32 sm:pb-20">
        <div className="mx-auto max-w-3xl">
          ...
          <h1
            className="mt-6 text-4xl font-medium tracking-[-0.03em] sm:text-5xl"
            style={{ color: C.deep }}
          >
            {t(
          ...
          <p className="mt-6 text-base leading-relaxed text-neutral-700 sm:text-lg dark:text-neutral-200">
            {t(
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full px-6 py-3.5 text-sm font-medium transition hover:opacity-90"
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-full border px-6 py-3.5 text-sm font-medium transition hover:brightness-[1.03]"
              style={{ borderColor: `${C.soft}80`, backgroundColor: C.card, color: C.deep }}
            >
              WhatsApp
            </a>
          </div>
