...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Social media works differently for healthcare than for most industries — the content that builds trust is educational and behind-the-scenes, not sales-driven, and testimonials need to be handled carefully to stay within advertising rules. We go deeper on what actually works in [social media for doctors](/blog/redes-sociales-para-doctores).",
        ],
        bodyEs: [
          "Las redes sociales funcionan distinto para salud que para la mayoría de las industrias: el contenido que genera confianza es educativo y detrás de cámaras, no orientado a la venta, y los testimonios hay que manejarlos con cuidado para mantenerse dentro de las reglas publicitarias. Profundizamos en qué funciona realmente en [redes sociales para doctores](/blog/redes-sociales-para-doctores).",
        ],
      },
      {
        id: "presupuesto",
        ...
        body: [
          "Medical and dental marketing typically costs more than average because patient acquisition value is high and the sales cycle involves more trust-building steps. The full budget breakdown is in [how much to invest in medical marketing](/blog/cuanto-invertir-en-marketing-medico).",
        ],
        bodyEs: [
          "El marketing médico y dental suele costar más que el promedio porque el valor de adquisición de paciente es alto y el ciclo de venta involucra más pasos de construcción de confianza. El desglose completo de presupuesto está en [cuánto invertir en marketing médico](/blog/cuanto-invertir-en-marketing-medico).",
        ],
      },
      {
        id: "errores-comunes",
  ...
  },
  {
    ...
    categoryEs: "Marketing Médico",
    excerpt:
      "Most review advice for clinics quietly describes practices Google prohibits. Here is what the policy actually says, and a request system that works inside it.",
    excerptEs:
      "Casi todo el consejo sobre reseñas para clínicas describe prácticas que Google prohíbe. Esto es lo que dice la política y un sistema de solicitud que funciona dentro de ella.",
    readingTime: 9,
    date: "2026-11-12",
    author: "Aphelion",
    authorRole: "Marketing Team",
    authorRoleEs: "Equipo de Marketing",
    lede: "Reviews decide which clinic a patient calls, so the pressure to game them is real. The problem is that the three most common tactics — filtering unhappy patients, offering a small gift, asking at the front desk — are each named in Google's policy as violations.",
    ledeEs:
      "Las reseñas deciden a qué clínica llama un paciente, así que la presión por manipularlas es real. El problema es que las tres tácticas más comunes, filtrar al paciente molesto, ofrecer un detalle y pedirla en recepción, están nombradas una por una en la política de Google como infracciones.",
    sections: [
      {
        id: "lo-que-prohibe",
        heading: "What the policy actually prohibits",
        headingEs: "Lo que la política realmente prohíbe",
        body: [
          "Google's prohibited and restricted content policy for business profiles is unusually specific about reviews, and the specifics matter because each one maps to a tactic clinics use every day.",
          "Offering an incentive is out: payment, discounts, free goods or services in exchange for posting a review, revising one, or taking a negative one down. A free cleaning for a five-star review is the textbook case.",
          "Selective solicitation is out. You cannot discourage negative reviews or ask only the happy patients. The practice usually called review gating, where you survey the patient first and only send the Google link to the ones who rated you well, falls squarely here.",
          "Pressure on the premises is out. Merchants should not require or pressure users to leave a rating while they are still in the building, and should not ask that specific content be included. The tablet at the front desk with the receptionist watching is the version of this most clinics do not realise is a problem.",
          "The penalty is not only that the fake reviews get deleted. Google states that a profile can be blocked from receiving new reviews for a period, or have its existing reviews unpublished for a period. A practice that spent two years accumulating reviews can lose the visible result of that work.",
        ],
        bodyEs: [
          "La política de contenido prohibido y restringido de Google para perfiles de negocio es inusualmente específica con las reseñas, y los detalles importan porque cada uno corresponde a una táctica que las clínicas usan a diario.",
          "Ofrecer un incentivo queda fuera: pago, descuentos, bienes o servicios gratuitos a cambio de publicar una reseña, modificarla o quitar una negativa. La limpieza dental gratis a cambio de cinco estrellas es el caso de manual.",
          "La solicitud selectiva queda fuera. No puedes desalentar reseñas negativas ni pedirlas solo a los pacientes contentos. La práctica que suele llamarse review gating, donde encuestas primero al paciente y solo le mandas el enlace de Google a quien te calificó bien, cae de lleno aquí.",
          "La presión en el consultorio queda fuera. Google señala que los negocios no deben exigir ni presionar al usuario para dejar una calificación mientras sigue en el establecimiento, ni pedirle que incluya contenido específico. La tablet en recepción con la asistente mirando es la versión que la mayoría de las clínicas no identifica como problema.",
          "La sanción no es solo que borren las reseñas falsas. Google indica que un perfil puede quedar bloqueado para recibir reseñas nuevas durante un periodo, o que sus reseñas existentes se dejen de publicar durante un periodo. Un consultorio que tardó dos años en acumular reseñas puede perder el resultado visible de ese trabajo.",
        ],
      },
      {
        id: "pedir-a-todos",
        heading: "Ask everyone, which is also the compliant option",
        headingEs: "Pídesela a todos, que además es la opción que cumple",
        body: [
          "The way out of gating is counterintuitive: ask every patient, without filtering. It is the compliant path and it usually produces a better rating than filtering does.",
          "The arithmetic is the reason. A practice that only asks its ten happiest patients a month gets ten reviews and a fragile average, because one unhappy patient who finds the profile on their own moves it visibly. A practice that asks all eighty gets a larger denominator, and a single bad experience lands against a much heavier base.",
          "Filtering also concentrates your negative reviews into the population most motivated to write them. Unprompted reviews skew negative, because irritation is a stronger writing motive than satisfaction. Asking everyone is how you get the satisfied majority to bother.",
          "This is not an argument for ignoring the unhappy patient. It is an argument for handling the complaint directly and asking for the review anyway.",
        ],
        bodyEs: [
          "La salida al gating es contraintuitiva: pídesela a todos los pacientes, sin filtrar. Es el camino que cumple y normalmente produce mejor calificación que filtrar.",
          "La razón es aritmética. Un consultorio que solo le pide a sus diez pacientes más contentos al mes junta diez reseñas y un promedio frágil, porque un paciente molesto que encuentra el perfil por su cuenta lo mueve de forma visible. Un consultorio que le pide a los ochenta obtiene un denominador más grande, y una sola mala experiencia cae contra una base mucho más pesada.",
          "Filtrar además concentra tus reseñas negativas en la población con más motivación para escribirlas. Las reseñas espontáneas se inclinan a lo negativo, porque el enojo es un motivo para escribir más fuerte que la satisfacción. Pedírsela a todos es la manera de lograr que la mayoría satisfecha se tome la molestia.",
          "Esto no es un argumento para ignorar al paciente molesto. Es un argumento para atender la queja de frente y pedirle la reseña de todos modos.",
        ],
      },
      {
        id: "el-momento",
        heading: "Timing beats wording",
        headingEs: "El momento pesa más que la redacción",
        body: [
          "Clinics spend a lot of energy on the wording of the request and almost none on when it goes out. The order of importance is the reverse.",
          "The request should arrive after the patient knows whether the treatment worked, not when they walk out the door. For a cleaning that is the same day. For an implant, an orthodontic phase, or a surgical recovery, it is weeks later, once the result is evident. Asking a patient to evaluate a procedure whose outcome they cannot yet judge produces vague reviews, and vague reviews convert worse than specific ones.",
          "Send it when the person is not in the clinic. This is both the policy-safe option and the practical one, since they need their phone, a minute, and no one watching.",
          "One reminder, then stop. A second nudge to a patient who ignored the first is the point where a reasonable request starts to feel like pressure.",
        ],
        bodyEs: [
          "Las clínicas gastan mucha energía en la redacción de la solicitud y casi nada en cuándo sale. El orden de importancia es al revés.",
          "La solicitud debe llegar cuando el paciente ya sabe si el tratamiento funcionó, no al momento de salir por la puerta. Para una limpieza eso es el mismo día. Para un implante, una fase de ortodoncia o una recuperación quirúrgica, son semanas después, cuando el resultado es evidente. Pedirle a un paciente que evalúe un procedimiento cuyo desenlace todavía no puede juzgar produce reseñas vagas, y las reseñas vagas convierten peor que las específicas.",
          "Mándala cuando la persona no esté en la clínica. Es a la vez la opción segura frente a la política y la práctica, porque necesita su teléfono, un minuto y que nadie la esté viendo.",
          "Un recordatorio y ya. Un segundo empujón a quien ignoró el primero es el punto donde una petición razonable empieza a sentirse como presión.",
        ],
      },
      {
        id: "responder-sin-violar-secreto",
        heading: "Responding without breaching confidentiality",
        headingEs: "Responder sin violar el secreto profesional",
        body: [
          "Here is the part that is specific to medicine, and where generic review advice becomes dangerous.",
          "Responding to a review is normally good practice. In a clinic, the response itself can confirm that the reviewer is a patient. NOM-004-SSA3-2012 treats the patient's identity and the information provided about their condition as confidential, and the current federal data protection law classifies health data as sensitive personal data. A reply that says \"we're sorry your root canal was uncomfortable, Mr. Ramírez\" has just published a treatment and a name.",
          "The patient disclosing it first does not transfer the obligation to you. Their choice to write publicly about their own care is theirs to make; your duty of confidentiality is not waived by it.",
          "This is a regulatory summary and not legal advice; confirm with a specialised lawyer how it applies to your practice. The workable pattern is to respond without confirming anything. Thank the person for the feedback, state the clinic's general standard, and move the specifics to a private channel with a phone number. No diagnosis, no procedure, no dates, no confirmation that they attended.",
          "For a negative review this is also the better tactic commercially. The audience for your reply is not the reviewer, it is the next person reading the profile, and a calm response that does not argue reads as competence.",
        ],
        bodyEs: [
          "Esta es la parte específica de la medicina, y donde el consejo genérico sobre reseñas se vuelve peligroso.",
          'Responder una reseña normalmente es buena práctica. En una clínica, la respuesta misma puede confirmar que quien reseña es paciente. La NOM-004-SSA3-2012 trata la identidad del paciente y la información que proporciona sobre su padecimiento como información confidencial, y la ley federal vigente de protección de datos clasifica los datos de salud como datos personales sensibles. Una respuesta que dice "lamentamos que su endodoncia fuera incómoda, señor Ramírez" acaba de publicar un tratamiento y un nombre.',
          "Que el paciente lo haya revelado primero no te transfiere la obligación. Su decisión de escribir públicamente sobre su propia atención es suya; tu deber de confidencialidad no queda anulado por ella.",
          "Esto es un resumen normativo y no asesoría legal; confirma con un abogado especializado cómo aplica a tu consultorio. El patrón que funciona es responder sin confirmar nada. Agradece el comentario, expón el estándar general de la clínica y lleva lo específico a un canal privado con un número de teléfono. Sin diagnóstico, sin procedimiento, sin fechas, sin confirmar que la persona asistió.",
          "Para una reseña negativa esta además es la mejor táctica comercial. El público de tu respuesta no es quien reseñó, es la siguiente persona que lee el perfil, y una respuesta serena que no discute se lee como competencia.",
        ],
      },
      {
        id: "el-sistema",
        heading: "The request system, end to end",
        headingEs: "El sistema de solicitud, de principio a fin",
        body: [
          "A system beats good intentions, because good intentions stop the first week the clinic is full.",
          "Generate the short link from your Business Profile once and keep it somewhere the whole team can reach. A long Maps URL typed on a phone loses people.",
          "Decide the trigger per treatment type, not per patient. Same day for hygiene and routine consults, a defined number of weeks after for anything whose result takes time. Written down, so it does not depend on who is at the desk.",
          "Send it by the channel the patient already uses with you, which in Mexico is usually WhatsApp. If you are automating that, the message should contain no clinical information at all, only a thank you and the link. We go into the confidentiality constraints of that channel in [WhatsApp para clínicas](/blog/whatsapp-para-clinicas).",
          "Assign one person to read new reviews weekly and draft replies. It takes fifteen minutes and it is the only step that reliably gets dropped.",
          "Do not buy reviews. Beyond the policy problem, purchased reviews are generic, and generic reviews on a medical profile read as fake to exactly the cautious patient you were trying to convince.",
        ],
        bodyEs: [
          "Un sistema le gana a las buenas intenciones, porque las buenas intenciones se acaban la primera semana que la clínica está llena.",
          "Genera el enlace corto desde tu Perfil de Empresa una vez y guárdalo donde todo el equipo lo alcance. Una URL larga de Maps tecleada en un teléfono pierde gente.",
          "Define el disparador por tipo de tratamiento, no por paciente. El mismo día para higiene y consultas de rutina, un número definido de semanas después para todo aquello cuyo resultado tarda. Por escrito, para que no dependa de quién esté en recepción.",
          "Mándala por el canal que el paciente ya usa contigo, que en México suele ser WhatsApp. Si vas a automatizarlo, el mensaje no debe contener información clínica alguna, solo un agradecimiento y el enlace. Entramos a las restricciones de confidencialidad de ese canal en [WhatsApp para clínicas](/blog/whatsapp-para-clinicas).",
          "Asigna a una persona para leer las reseñas nuevas cada semana y redactar respuestas. Toma quince minutos y es el único paso que se cae de manera confiable.",
          "No compres reseñas. Más allá del problema de política, las reseñas compradas son genéricas, y las reseñas genéricas en un perfil médico se leen como falsas justo para el paciente cauteloso al que querías convencer.",
        ],
      },
      {
        id: "que-medir",
        ...
        headingEs: "Qué medir",
        body: [
          "Two numbers tell you whether the system is running, and neither is the star average.",
          "The first is requests sent divided by patients seen. If that ratio is well under one, the problem is the process, not the patients, and no amount of rewriting the message will fix it.",
          "The second is reviews received divided by requests sent. This one measures whether your timing and channel are right. A low number here with a healthy first number means you are asking at the wrong moment or through the wrong channel.",
          "The star average is an outcome, not a lever. Watching it daily produces anxiety and no decisions. Watching the two ratios produces changes you can actually make.",
        ],
        bodyEs: [
          "Dos números te dicen si el sistema está corriendo, y ninguno es el promedio de estrellas.",
          "El primero es solicitudes enviadas entre pacientes atendidos. Si esa razón está muy por debajo de uno, el problema es el proceso, no los pacientes, y ninguna cantidad de reescribir el mensaje lo va a arreglar.",
          "El segundo es reseñas recibidas entre solicitudes enviadas. Este mide si tu momento y tu canal son los correctos. Un número bajo aquí con un primer número sano significa que estás pidiendo en el momento equivocado o por el canal equivocado.",
          "El promedio de estrellas es un resultado, no una palanca. Verlo a diario produce ansiedad y ninguna decisión. Ver las dos razones produce cambios que sí puedes hacer.",
        ],
      },
    ],
    gradient: "from-neutral-800 to-zinc-950",
    faq: [
      {
        ...
        qEn: "Can I offer a discount in exchange for a review?",
        a: "No. La política de Google prohíbe expresamente ofrecer pago, descuentos o bienes y servicios gratuitos a cambio de publicar una reseña, modificarla o retirarla. Las reseñas incentivadas se eliminan y el perfil puede quedar restringido para recibir reseñas nuevas durante un periodo.",
        aEn: "No. Google's policy expressly prohibits offering payment, discounts, or free goods and services in exchange for posting, revising, or removing a review. Incentivized reviews are removed and the profile can be restricted from receiving new reviews for a period.",
      },
      {
        q: "¿Puedo encuestar primero y solo mandarle el enlace a quien quedó contento?",
        qEn: "Can I survey patients first and only send the link to the happy ones?",
        a: "No. Eso es review gating y cae dentro de la prohibición de desalentar reseñas negativas o solicitar selectivamente las positivas. Además suele empeorar tu calificación, porque reduce el denominador y concentra las negativas en quienes las escriben por su cuenta.",
        aEn: "No. That is review gating, and it falls under the prohibition on discouraging negative reviews or selectively soliciting positive ones. It also tends to worsen your rating, because it shrinks the denominator and concentrates negatives among people who write on their own.",
      },
      {
        q: "¿Puedo responder una reseña mencionando el tratamiento del paciente?",
        qEn: "Can I reply to a review mentioning the patient's treatment?",
        a: "No es recomendable. La NOM-004-SSA3-2012 trata la identidad del paciente y la información sobre su padecimiento como confidencial, y la ley vigente de protección de datos considera sensibles los datos de salud. Que el paciente lo haya publicado no anula tu deber. Responde sin confirmar la atención y lleva lo específico a un canal privado.",
        aEn: "It is not advisable. NOM-004-SSA3-2012 treats patient identity and information about their condition as confidential, and current data protection law classifies health data as sensitive. The patient publishing it first does not waive your duty. Reply without confirming care and move specifics to a private channel.",
      },
      {
        q: "¿Qué hago con una reseña que creo que es falsa?",
        qEn: "What do I do about a review I believe is fake?",
        a: "Repórtala a Google por los canales del Perfil de Empresa y responde públicamente en tono neutral mientras se resuelve. No la ignores: una reseña negativa sin respuesta pesa más ante quien lee que una respuesta serena. Y no pidas a tu equipo que publique reseñas positivas para compensar, porque eso sí es una infracción por tu lado.",
        aEn: "Report it to Google through Business Profile channels and reply publicly in a neutral tone while it is resolved. Do not ignore it: an unanswered negative review carries more weight with readers than a calm reply. And do not ask your team to post positive reviews to compensate, because that is a violation on your side.",
      },
      {
        q: "¿Cuántas reseñas necesito para competir?",
        qEn: "How many reviews do I need to compete?",
        a: "El número útil no es absoluto sino relativo a tu zona. Revisa los perfiles que aparecen arriba para tus búsquedas en tu ciudad, anota su cantidad y su promedio, y usa eso como referencia. Una clínica en una zona con perfiles de veinte reseñas necesita algo muy distinto a una que compite contra perfiles de varios cientos.",
        aEn: "The useful number is not absolute but relative to your area. Look at the profiles ranking above you for your searches in your city, note their count and average, and use that as the benchmark. A clinic in an area where profiles have twenty reviews needs something very different from one competing against profiles with several hundred.",
      },
    ],
    schema: {
      keywords: [
      ...
      keywordsEs: [
        "como conseguir reseñas google medicos",
        "reseñas google consultorio",
        "review gating",
        "reputacion clinica",
      ],
    },
  },
  {
    ...
    categoryEs: "Marketing Médico",
    excerpt:
      "Most clinics do not need Google healthcare certification. What stops their campaigns is a different policy, plus a Mexican regulation almost no one applies to their ad copy.",
    excerptEs:
      "La mayoría de las clínicas no necesita certificación de salud de Google. Lo que frena sus campañas es otra política, más una norma mexicana que casi nadie aplica a sus anuncios.",
    readingTime: 10,
    date: "2026-11-14",
    author: "Aphelion",
    authorRole: "Marketing Team",
    authorRoleEs: "Equipo de Marketing",
    lede: "There are two separate rulebooks over a medical campaign in Mexico, and clinics tend to worry about the wrong one. Google's healthcare certification gets the attention, while the restriction that actually disapproves ads and the Mexican advertising rule that actually carries a sanction go unread.",
    ledeEs:
      "Sobre una campaña médica en México hay dos reglamentos distintos, y las clínicas suelen preocuparse por el equivocado. La certificación de salud de Google se lleva la atención, mientras la restricción que de verdad desaprueba anuncios y la norma mexicana que de verdad trae sanción se quedan sin leer.",
    sections: [
      {
        id: "certificacion",
        heading: "You probably do not need the certification",
        headingEs: "Probablemente no necesitas la certificación",
        body: [
          "Google's healthcare and medicines policy requires certification for a defined set of businesses: online pharmacies, prescription drug services, addiction treatment services, telemedicine providers, health insurance advertisers, and pharmaceutical manufacturers. Some of those require third-party accreditation first, from bodies such as LegitScript, NABP or G2.",
          "A dental practice advertising cleanings, a dermatologist advertising consultations, an ophthalmologist advertising cataract surgery: none of those categories is on that list. They advertise as ordinary local businesses.",
          "This matters because clinics spend weeks chasing a certification they do not need while their real problem sits untouched. If you offer telemedicine consultations or dispense prescription drugs, read the certification requirements carefully. If you run a physical practice treating patients in person, start elsewhere.",
          "Worth knowing if you do fall under the policy: as of the April 2026 update, Google states that violations of the healthcare and medicines policy will not lead to immediate account suspension without prior warning, and that a warning will be issued at least seven days before any suspension.",
        ],
        bodyEs: [
          "La política de atención sanitaria y medicamentos de Google exige certificación para un conjunto definido de negocios: farmacias en línea, servicios de medicamentos con receta, servicios de tratamiento de adicciones, proveedores de telemedicina, anunciantes de seguros médicos y fabricantes farmacéuticos. Algunos requieren primero una acreditación de terceros, de organismos como LegitScript, NABP o G2.",
          "Un consultorio dental que anuncia limpiezas, un dermatólogo que anuncia consultas, un oftalmólogo que anuncia cirugía de cataratas: ninguna de esas categorías está en esa lista. Anuncian como cualquier negocio local.",
          "Esto importa porque las clínicas se pasan semanas persiguiendo una certificación que no necesitan mientras su problema real sigue intacto. Si ofreces consultas de telemedicina o dispensas medicamentos con receta, lee los requisitos de certificación con cuidado. Si tienes un consultorio físico que atiende pacientes en persona, empieza por otro lado.",
          "Vale la pena saberlo si sí caes bajo la política: desde la actualización de abril de 2026, Google señala que las infracciones a la política de atención sanitaria y medicamentos no llevan a suspensión inmediata de la cuenta sin aviso previo, y que se emite una advertencia al menos siete días antes de cualquier suspensión.",
        ],
      },
      {
        id: "publicidad-personalizada",
        heading: "The restriction that actually breaks campaigns",
      ...
      {
        id: "cofepris",
        heading: "The Mexican rule nobody puts in the ad",
      ...
      {
        id: "aviso-o-permiso",
        heading: "Aviso or permiso, and the deadline everyone gets backwards",
        headingEs: "Aviso o permiso, y el plazo que todos invierten",
        body: [
          "Two different procedures exist and which one applies depends on who is advertising, not on the medium.",
          "Article 86 lists what requires an aviso, a notice filed with the authority, and its first item is the professional, technical and auxiliary activities and specialties. This is the individual practitioner advertising their own professional practice.",
          "Article 79 lists what requires a permiso, an authorisation, and its first item is the provision of health services, except where services are provided individually. A clinic or hospital as an establishment therefore sits on the permiso side. Item six of the same article covers beautification services and procedures, with no individual exception, which is the one aesthetic and cosmetic dental practices should read twice.",
          "Now the deadline, which is the detail almost every summary gets wrong. Article 87 sets the general rule that an aviso is filed within the five days after the advertising starts running. Then its final paragraph carves out professional activities specifically: that aviso must be filed within the five days prior to the start of distribution. Before, not after. Same article, opposite direction.",
          "Article 78 closes the loop from the other side. Media outlets must ensure the advertising they carry has the corresponding permiso or a filed aviso, and the advertiser has to hand the outlet a copy. Platforms do not enforce this in practice, which is exactly why nobody notices they are out of compliance until someone complains.",
          "This is regulatory summary, not legal advice. Before you file anything, confirm the current procedure and requirements with COFEPRIS or a specialised lawyer, since these provisions have been reformed repeatedly.",
        ],
        bodyEs: [
      ...
      {
        id: "que-si-funciona",
        heading: "What a compliant medical campaign looks like",
        headingEs: "Cómo se ve una campaña médica que sí cumple",
        body: [
          "Once you take the prohibited tactics off the table, what remains is narrower and works better than most clinics expect.",
          "Bid on intent, not on people. Someone searching for a dentist in your neighbourhood has told you everything you need and none of it required profiling them.",
          'Advertise the practice and the service, not the reader\'s condition. "Endodoncia en Tijuana, cita el mismo día" describes what you sell. "¿Te duele una muela?" addresses a health state.',
          "Put the credential and the institution on the landing page, above the fold. It satisfies article 19, and it is also a conversion element, because the patient is choosing who operates on them.",
          "Track calls, not clicks. Most medical conversions are phone calls, and a campaign optimised on clicks in this category optimises for the wrong thing. We cover the measurement setup in [errores de marketing dental](/blog/errores-marketing-dental).",
          "Keep the claims defensible. Article 18 aside, a promise of results in a medical ad is the fastest route to a complaint from a patient for whom it did not work.",
        ],
        bodyEs: [
          "Una vez que quitas de la mesa las tácticas prohibidas, lo que queda es más estrecho y funciona mejor de lo que la mayoría de las clínicas espera.",
          "Puja por intención, no por personas. Alguien que busca un dentista en tu colonia ya te dijo todo lo que necesitas y nada de eso requirió perfilarlo.",
          'Anuncia el consultorio y el servicio, no el padecimiento del lector. "Endodoncia en Tijuana, cita el mismo día" describe lo que vendes. "¿Te duele una muela?" se dirige a un estado de salud.',
          "Pon la credencial y la institución en la landing page, arriba del pliegue. Cumple el artículo 19 y además es un elemento de conversión, porque el paciente está eligiendo quién lo va a operar.",
          "Mide llamadas, no clics. La mayoría de las conversiones médicas son llamadas telefónicas, y una campaña optimizada a clics en esta categoría optimiza lo que no es. Cubrimos la medición en [errores de marketing dental](/blog/errores-marketing-dental).",
          "Mantén las afirmaciones defendibles. Aparte del artículo 18, prometer resultados en un anuncio médico es la vía más rápida a una queja de un paciente para quien no funcionó.",
        ],
      },
    ],
    gradient: "from-neutral-800 to-zinc-950",
    faq: [
      {
        q: "¿Mi consultorio dental necesita certificación de Google para anunciarse?",
        qEn: "Does my dental practice need Google certification to advertise?",
        a: "Normalmente no. La certificación de atención sanitaria de Google aplica a categorías definidas: farmacias en línea, servicios de medicamentos con receta, tratamiento de adicciones, telemedicina, seguros médicos y fabricantes farmacéuticos. Un consultorio que atiende pacientes en persona no está en esa lista y anuncia como cualquier negocio local.",
        aEn: "Usually not. Google's healthcare certification applies to defined categories: online pharmacies, prescription drug services, addiction treatment, telemedicine, health insurance and pharmaceutical manufacturers. A practice treating patients in person is not on that list and advertises as an ordinary local business.",
      },
      {
        q: "¿Puedo hacer remarketing a quienes visitaron mi página de un tratamiento?",
        qEn: "Can I remarket to people who visited a specific treatment page?",
        a: "Si esa página corresponde a un padecimiento, no. Google clasifica las condiciones de salud como categoría de interés sensible y sus principios de publicidad personalizada, que aplican al remarketing y a Customer Match, impiden usar categorías sensibles para segmentar. Segmentar por intención de búsqueda sigue disponible.",
        aEn: "If that page corresponds to a health condition, no. Google classifies health conditions as a sensitive interest category, and its personalized advertising principles, which apply to remarketing and Customer Match, prohibit using sensitive categories for targeting. Targeting by search intent remains available.",
      },
      {
        q: "¿Tengo que poner mi cédula profesional en los anuncios?",
        qEn: "Do I have to put my professional licence number in the ads?",
        a: "El artículo 19 del Reglamento de la Ley General de Salud en Materia de Publicidad exige expresar la institución educativa que expidió el título, diploma o certificado y, en su caso, el número de cédula profesional, cualquiera que sea el medio publicitario. Por espacio, en la práctica esto suele resolverse en la landing page a la que apunta el anuncio.",
        aEn: "Article 19 of the health advertising regulation requires stating the educational institution that issued the title, diploma or certificate and, where applicable, the professional licence number, in whatever advertising medium. Given space limits, in practice this is usually handled on the landing page the ad points to.",
      },
      {
        q: "¿Necesito aviso o permiso ante COFEPRIS?",
        qEn: "Do I need an aviso or a permiso from COFEPRIS?",
        a: "Depende de quién anuncia. Las actividades profesionales individuales requieren aviso, según el artículo 86. La prestación de servicios de salud como establecimiento requiere permiso, según el artículo 79, que exceptúa los servicios otorgados en forma individual. Los servicios y procedimientos de embellecimiento requieren permiso sin esa excepción. Confirma el trámite vigente con COFEPRIS o un abogado especializado.",
        aEn: "It depends on who is advertising. Individual professional activities require an aviso, per article 86. Provision of health services as an establishment requires a permiso, per article 79, which excepts individually provided services. Beautification services and procedures require a permiso with no such exception. Confirm the current procedure with COFEPRIS or a specialised lawyer.",
      },
      {
        q: "¿Cuándo se presenta el aviso, antes o después de lanzar?",
        qEn: "When is the aviso filed, before or after launch?",
        a: "Para actividades profesionales, antes. El artículo 87 fija como regla general los cinco días posteriores al inicio de la difusión, pero su párrafo final establece que el aviso de las actividades profesionales, técnicas, auxiliares y especialidades debe presentarse dentro de los cinco días previos al inicio de la difusión. Es el punto que más resúmenes invierten.",
        aEn: "For professional activities, before. Article 87 sets a general rule of five days after distribution starts, but its final paragraph establishes that the aviso for professional, technical and auxiliary activities and specialties must be filed within the five days prior to the start of distribution. It is the point most summaries get backwards.",
      },
      {
        q: "¿Puedo prometer resultados en un anuncio médico?",
        qEn: "Can I promise results in a medical ad?",
        a: "No conviene. El artículo 18 establece que no se autorizará la publicidad que ofrezca tratamientos preventivos, curativos o rehabilitatorios de naturaleza médica o paramédica cuya eficacia no haya sido comprobada científicamente. Al margen de la norma, prometer un resultado clínico es la vía más directa a una queja del paciente para quien no funcionó.",
        aEn: "It is inadvisable. Article 18 establishes that advertising offering preventive, curative or rehabilitative treatments of a medical or paramedical nature whose efficacy has not been scientifically proven will not be authorised. Regulation aside, promising a clinical outcome is the most direct route to a complaint from a patient for whom it did not work.",
      },
    ],
    schema: {
      keywords: [
        ...
        "healthcare personalized advertising",
        "clinic ppc mexico",
      ],
      keywordsEs: [
        "google ads para medicos restricciones",
        "publicidad medica cofepris",
        "anuncios clinica google",
        "reglamento publicidad sanitaria",
      ],
    },
  },
  {
    ...
    categoryEs: "Marketing Médico",
    excerpt:
      "Health pages are judged against a standard other industries never face. The signals that satisfy it overlap almost exactly with what Mexican law already requires you to publish.",
    excerptEs:
      "Las páginas de salud se evalúan contra un estándar que otras industrias nunca enfrentan. Las señales que lo satisfacen coinciden casi exactamente con lo que la ley mexicana ya te obliga a publicar.",
    readingTime: 9,
    date: "2026-11-17",
    author: "Aphelion",
    authorRole: "Marketing Team",
    authorRoleEs: "Equipo de Marketing",
    lede: "A page about garden furniture that is mediocre costs the reader a bad purchase. A page about drug interactions that is mediocre can cost them considerably more. Google's rating framework treats that asymmetry explicitly, and health content lands on the strict side of it.",
    ledeEs:
      "Una página mediocre sobre muebles de jardín le cuesta al lector una mala compra. Una página mediocre sobre interacciones entre medicamentos puede costarle bastante más. El marco de evaluación de Google trata esa asimetría de forma explícita, y el contenido de salud cae del lado estricto.",
    sections: [
      {
        id: "ymyl",
        heading: "What YMYL means for a clinic",
        headingEs: "Qué significa YMYL para una clínica",
        body: [
          "Google's quality rater guidelines define a class of pages called Your Money or Your Life, meaning topics that could affect a person's health, financial stability, safety or wellbeing. Medical and dental content sits inside it by definition.",
          "The consequence is not a separate algorithm. It is that the bar for what counts as adequate rises. A thin, unattributed page about a cosmetic procedure may rank acceptably. A thin, unattributed page about a surgical one is judged against a much higher expectation of who wrote it and what backs it.",
          "E-E-A-T is the vocabulary Google uses for this: experience, expertise, authoritativeness and trustworthiness. The first E, experience, was added later and it is the one clinics are best placed to demonstrate and least likely to bother with.",
          "It is worth being precise about what E-E-A-T is not. It is not a score in the algorithm that you can raise directly. It is a description of what the systems try to approximate. So the work is not to satisfy a metric, it is to publish the things a careful reader would want to see.",
        ],
        bodyEs: [
          "Las directrices de evaluadores de calidad de Google definen una clase de páginas llamada Your Money or Your Life, temas que pueden afectar la salud, la estabilidad financiera, la seguridad o el bienestar de una persona. El contenido médico y dental cae ahí por definición.",
          "La consecuencia no es un algoritmo aparte. Es que la vara de lo que se considera adecuado sube. Una página delgada y sin autoría sobre un procedimiento cosmético puede posicionar de forma aceptable. Una página delgada y sin autoría sobre uno quirúrgico se juzga contra una expectativa mucho más alta de quién la escribió y qué la respalda.",
          "E-E-A-T es el vocabulario que Google usa para esto: experiencia, pericia, autoridad y confiabilidad. La primera E, la experiencia vivida, se agregó después y es la que las clínicas están en mejor posición de demostrar y menos propensas a molestarse en mostrar.",
          "Conviene ser preciso sobre lo que E-E-A-T no es. No es una puntuación en el algoritmo que puedas subir de forma directa. Es una descripción de lo que los sistemas intentan aproximar. Así que el trabajo no es satisfacer una métrica, es publicar aquello que un lector cuidadoso querría ver.",
        ],
      },
      {
        id: "autoria",
        heading: "Authorship is the cheapest signal and the most neglected",
        headingEs: "La autoría es la señal más barata y la más descuidada",
        body: [
          "The single most common failure on Mexican clinic sites is content with no author at all. An article about periodontal disease published by nobody, reviewed by nobody, updated on no date.",
          "The fix costs nothing. Sign the article with the treating professional's name, their specialty, the institution that issued their degree and their professional licence number. Link it to a real biography page.",
          "Here is where two obligations converge conveniently. Article 19 of Mexico's health advertising regulation already requires that advertising by health professionals state the educational institution that issued their title, diploma or certificate and, where applicable, their licence number. The credential you have to publish for regulatory reasons is the same credential that establishes expertise for a reader and a search engine. Most clinics do neither, when doing one does both.",
          "If content is written by a marketing team rather than a clinician, say so and add a named clinical reviewer with a review date. That is honest, it is standard practice on serious health sites, and it is far better than an unsigned page pretending to authority it does not have.",
          "Give each professional a real biography page: training, years in practice, hospital affiliations, professional associations, the procedures they actually perform. This is the entity Google is trying to evaluate. A name in a byline that leads nowhere gives it nothing to work with.",
        ],
        bodyEs: [
          "La falla más común en los sitios de clínicas mexicanas es contenido sin autor. Un artículo sobre enfermedad periodontal publicado por nadie, revisado por nadie, actualizado en ninguna fecha.",
          "Corregirlo no cuesta nada. Firma el artículo con el nombre del profesional tratante, su especialidad, la institución que expidió su título y su número de cédula profesional. Enlázalo a una página de biografía real.",
          "Aquí convergen dos obligaciones de forma conveniente. El artículo 19 del reglamento mexicano de publicidad sanitaria ya exige que la publicidad de los profesionales de la salud exprese la institución educativa que expidió el título, diploma o certificado y, en su caso, el número de cédula. La credencial que tienes que publicar por razones normativas es la misma credencial que establece pericia ante un lector y ante un buscador. La mayoría de las clínicas no hace ninguna de las dos, cuando hacer una hace las dos.",
          "Si el contenido lo escribe un equipo de marketing y no un clínico, dilo y agrega un revisor clínico con nombre y fecha de revisión. Eso es honesto, es práctica estándar en los sitios serios de salud, y es muy superior a una página sin firma que finge una autoridad que no tiene.",
          "Dale a cada profesional una página de biografía real: formación, años de práctica, afiliaciones hospitalarias, asociaciones profesionales, los procedimientos que efectivamente realiza. Esta es la entidad que Google intenta evaluar. Un nombre en una firma que no lleva a ningún lado no le da con qué trabajar.",
        ],
      },
      {
        id: "fuentes",
        heading: "Cite primary sources, and cite them properly",
        headingEs: "Cita fuentes primarias, y cítalas bien",
        body: [
          "Health content that cites nothing is asking to be trusted on assertion. Health content that cites another clinic's blog post is worse, because it inherits that page's errors.",
          'Cite the primary source: the norma oficial mexicana, the Secretaría de Salud guidance, the clinical practice guideline, the peer-reviewed study, the manufacturer\'s instructions for use. Link to it. Name it in the text rather than hiding it behind a vague "studies show."',
          "Date-stamp claims that move. Prevalence figures, treatment protocols and regulatory requirements all change, and a page confidently stating a 2019 protocol in 2026 signals neglect more loudly than no page at all.",
          "A concrete example of why this matters: a great deal of Mexican clinic content about patient data still cites the INAI as the supervising authority. Under the data protection law published in the Diario Oficial de la Federación on 20 March 2025 and in force the following day, the INAI was dissolved and its functions in this area transferred to the Secretaría de Anticorrupción y Buen Gobierno. Any page still naming the INAI is visibly out of date, and it is out of date on precisely the kind of factual point a careful reader can check in thirty seconds.",
          'Distinguish what is established from what is contested. Writing "the evidence is mixed" where the evidence is mixed builds more trust than flattening it into certainty, and it is the difference between a page written by someone who knows the field and one written from three competitor blogs.',
        ],
        bodyEs: [
          "El contenido de salud que no cita nada está pidiendo que se le crea por afirmación. El contenido de salud que cita el blog de otra clínica es peor, porque hereda los errores de esa página.",
          'Cita la fuente primaria: la norma oficial mexicana, la guía de la Secretaría de Salud, la guía de práctica clínica, el estudio revisado por pares, las instrucciones de uso del fabricante. Enlázala. Nómbrala en el texto en lugar de esconderla detrás de un vago "los estudios demuestran".',
          "Ponle fecha a las afirmaciones que se mueven. Las cifras de prevalencia, los protocolos de tratamiento y los requisitos normativos cambian, y una página que en 2026 afirma con seguridad un protocolo de 2019 comunica descuido con más fuerza que no tener página.",
          "Un ejemplo concreto de por qué importa: buena parte del contenido de clínicas mexicanas sobre datos de pacientes sigue citando al INAI como autoridad supervisora. Con la ley de protección de datos publicada en el Diario Oficial de la Federación el 20 de marzo de 2025 y vigente al día siguiente, el INAI se extinguió y sus funciones en esta materia pasaron a la Secretaría de Anticorrupción y Buen Gobierno. Cualquier página que siga nombrando al INAI está visiblemente desactualizada, y lo está justo en el tipo de dato factual que un lector cuidadoso puede verificar en treinta segundos.",
          'Distingue lo establecido de lo discutido. Escribir "la evidencia es mixta" donde la evidencia es mixta construye más confianza que aplanarla en certeza, y es la diferencia entre una página escrita por alguien que conoce el campo y una escrita a partir de tres blogs de la competencia.',
        ],
      },
      {
        id: "experiencia",
        heading: "The first E: experience you can actually show",
        headingEs: "La primera E: experiencia que sí puedes mostrar",
        body: [
          "Expertise is credentials. Experience is having done the thing. A practising clinician has an enormous amount of the second and almost never puts it on the page.",
          "Case descriptions, written within confidentiality limits, are the strongest form. NOM-004-SSA3-2012 establishes that for purposes of medical literature, teaching, research or photographs that allow identifying the patient, publishing or disclosing personal data from the clinical file requires the patient's written authorisation, and obliges adopting the measures needed so the patient cannot be identified. This is a regulatory summary, not legal advice: confirm the requirements applicable to your case with a specialised lawyer. Within those limits, describing what a case presented with, what was considered, what was done and how it resolved demonstrates experience no amount of general prose can imitate.",
          "Volume statements help when they are true and specific. The number of a given procedure performed, the years the practice has operated, the equipment actually in the building.",
          "Photographs of your own clinic, staff and equipment do more than stock imagery does. A page about implant surgery illustrated with a stock photo of a smiling model is a page that has told the reader nothing about you.",
          "Answer the questions patients actually ask in consultation, in the words they use. The recovery, the pain, the cost, whether they can drive home, what happens if it fails. Clinical writing tends toward the procedure; patients arrive worrying about the aftermath.",
        ],
        bodyEs: [
          "La pericia son las credenciales. La experiencia es haber hecho la cosa. Un clínico en ejercicio tiene enormes cantidades de la segunda y casi nunca la pone en la página.",
          "Las descripciones de caso, escritas dentro de los límites de confidencialidad, son la forma más fuerte. La NOM-004-SSA3-2012 establece que para efectos de literatura médica, docencia, investigación o fotografías que permitan identificar al paciente, publicar o divulgar datos personales del expediente clínico requiere autorización escrita del paciente, y obliga a adoptar las medidas necesarias para que no pueda ser identificado. Este es un resumen normativo, no asesoría legal: confirma los requisitos aplicables a tu caso con un abogado especializado. Dentro de esos límites, describir con qué llegó un caso, qué se consideró, qué se hizo y cómo se resolvió demuestra experiencia que ninguna cantidad de prosa general puede imitar.",
          "Los datos de volumen ayudan cuando son ciertos y específicos. El número de determinado procedimiento realizado, los años que lleva operando el consultorio, el equipo que efectivamente está en el edificio.",
          "Las fotografías de tu propia clínica, tu equipo y tu instrumental hacen más que las imágenes de banco. Una página sobre cirugía de implantes ilustrada con una foto de banco de una modelo sonriendo es una página que no le dijo nada al lector sobre ti.",
          "Responde las preguntas que los pacientes de verdad hacen en consulta, con las palabras que usan. La recuperación, el dolor, el costo, si pueden manejar de regreso, qué pasa si falla. La escritura clínica tiende al procedimiento; los pacientes llegan preocupados por el después.",
        ],
      },
      {
        id: "confianza",
        heading: "Trustworthiness is mostly infrastructure",
        ...
        body: [
          ...
          "Working links, current pages, no orphaned service pages for procedures you stopped offering two years ago. We cover the structural side of this in [sitio web para clínicas](/blog/sitio-web-para-clinicas).",
        ],
        bodyEs: [
          ...
          "Enlaces que funcionan, páginas al día, sin páginas de servicio huérfanas de procedimientos que dejaste de ofrecer hace dos años. Cubrimos el lado estructural en [sitio web para clínicas](/blog/sitio-web-para-clinicas).",
        ],
      },
      {
        id: "por-donde-empezar",
        heading: "Where to start if the site already exists",
        headingEs: "Por dónde empezar si el sitio ya existe",
        body: [
          "Rewriting everything is the plan that never happens. Order the work instead.",
          "First, sign what already exists. Adding author, credential and review date to your current articles is a day of work and it addresses the most common gap.",
          "Second, build the biography pages. One per professional, real detail, linked from every article they sign.",
          "Third, audit the pages that make claims. Anything promising a result, a recovery time or a success rate needs a source or a rewrite, and this is where regulatory and quality risk overlap.",
          "Fourth, fix the privacy notice and the contact consistency.",
          "Only then write new content. New articles on a site with no authorship infrastructure inherit the same weakness the old ones had.",
        ],
        bodyEs: [
          "Reescribir todo es el plan que nunca ocurre. Ordena el trabajo en lugar de eso.",
          "Primero, firma lo que ya existe. Agregar autor, credencial y fecha de revisión a tus artículos actuales es un día de trabajo y atiende el hueco más común.",
          "Segundo, construye las páginas de biografía. Una por profesional, con detalle real, enlazada desde cada artículo que firma.",
          "Tercero, audita las páginas que hacen afirmaciones. Todo lo que prometa un resultado, un tiempo de recuperación o una tasa de éxito necesita fuente o reescritura, y aquí es donde se superponen el riesgo normativo y el de calidad.",
          "Cuarto, corrige el aviso de privacidad y la consistencia de los datos de contacto.",
          "Solo entonces escribe contenido nuevo. Los artículos nuevos en un sitio sin infraestructura de autoría heredan la misma debilidad que tenían los viejos.",
        ],
      },
    ],
    gradient: "from-neutral-800 to-zinc-950",
    faq: [
      {
        q: "¿E-E-A-T es un factor de posicionamiento?",
        qEn: "Is E-E-A-T a ranking factor?",
        a: "No en el sentido de una puntuación que puedas subir. Es el marco que Google usa para describir lo que sus sistemas intentan aproximar, y aparece en las directrices para evaluadores humanos de calidad. La consecuencia práctica es la misma: publicar autoría, credenciales y fuentes verificables mejora cómo se evalúa la página.",
        aEn: "Not in the sense of a score you can raise. It is the framework Google uses to describe what its systems try to approximate, and it appears in the guidelines for human quality raters. The practical consequence is the same: publishing authorship, credentials and verifiable sources improves how the page is assessed.",
      },
      {
        q: "¿Puedo publicar fotos de antes y después de mis pacientes?",
        qEn: "Can I publish before and after photos of my patients?",
        a: "Solo con autorización por escrito. La NOM-004-SSA3-2012 exige autorización escrita del paciente para publicar o divulgar datos del expediente clínico o fotografías que permitan identificarlo, y exige tomar las medidas necesarias para que no pueda ser identificado. El consentimiento verbal no cumple.",
        aEn: "Only with written authorisation. NOM-004-SSA3-2012 requires written patient authorisation to publish or disclose clinical file data or photographs that could identify the patient, and requires taking measures so the patient cannot be identified. Verbal consent does not satisfy it.",
      },
      {
        q: "¿Sirve que escriba el contenido un redactor y no el médico?",
        qEn: "Is it acceptable for a writer rather than the doctor to write the content?",
        a: "Sí, si se declara. Lo estándar en sitios serios de salud es acreditar al redactor y sumar un revisor clínico con nombre, credencial y fecha de revisión. Lo que no funciona es una página sin firma que aparenta autoridad clínica que nadie asume.",
        aEn: "Yes, if it is disclosed. The standard on serious health sites is to credit the writer and add a named clinical reviewer with credential and review date. What does not work is an unsigned page implying clinical authority nobody has taken responsibility for.",
      },
      {
        q: "¿Cada cuánto debo actualizar el contenido médico?",
        qEn: "How often should medical content be updated?",
        a: "Cuando cambie el hecho, no en un calendario fijo. Los protocolos clínicos, los requisitos normativos y las cifras de prevalencia se mueven a ritmos distintos. Lo útil es marcar cada afirmación con su fuente y su fecha, de modo que revisar sea rápido y evidente cuando algo quedó viejo.",
        aEn: "When the fact changes, not on a fixed calendar. Clinical protocols, regulatory requirements and prevalence figures move at different rates. What works is tagging each claim with its source and date, so reviewing is quick and it is obvious when something has aged.",
      },
      {
        q: "¿Los datos estructurados de tipo MedicalWebPage ayudan?",
        qEn: "Does MedicalWebPage structured data help?",
        a: "Ayudan a que el buscador entienda qué es la página y quién la firma, pero no sustituyen las señales que describen. El marcado que declara un autor con credenciales sobre una página sin biografía real ni fuentes no crea autoridad, solo la anuncia.",
        aEn: "It helps the search engine understand what the page is and who signed it, but it does not substitute for the signals it describes. Markup declaring a credentialed author on a page with no real biography and no sources does not create authority, it merely announces it.",
      },
    ],
    schema: {
      keywords: [
        "eeat medical content",
        "ymyl health seo",
        "medical authorship",
        "clinical content trust signals",
      ],
      keywordsEs: [
        "eeat contenido medico",
        "ymyl salud seo",
        "autoria medica sitio",
        "contenido clinico confiable",
      ],
    },
  },
  {
    ...
    categoryEs: "Marketing Médico",
    excerpt:
      "A clinic site has to do three jobs a normal business site does not: prove a credential, book an appointment, and handle sensitive data lawfully.",
    excerptEs:
      "El sitio de una clínica tiene que hacer tres trabajos que un sitio de negocio normal no: acreditar una credencial, agendar una cita y tratar datos sensibles conforme a la ley.",
    readingTime: 9,
    date: "2026-11-19",
    author: "Aphelion",
    authorRole: "Marketing Team",
    authorRoleEs: "Equipo de Marketing",
    lede: "Most clinic websites are brochures with a phone number. The patient arriving on one has already decided they need treatment and is now deciding whether to trust you with it, which is a different question and needs a different page.",
    ledeEs:
      "La mayoría de los sitios de clínicas son folletos con un número de teléfono. El paciente que llega a uno ya decidió que necesita tratamiento y ahora está decidiendo si confía en ti para hacerlo, que es otra pregunta y necesita otra página.",
    sections: [
      {
        id: "la-decision",
        heading: "The decision the page has to support",
        headingEs: "La decisión que la página tiene que sostener",
        body: [
          "Before writing a single section it is worth being clear about what the visitor is doing, because it is not what a visitor to an e-commerce site is doing.",
          "They are rarely browsing. They have a symptom, a referral or a quoted price from somewhere else, and they are comparing two or three options. The comparison is not on features. It is on whether this person is competent and whether the process will be manageable.",
          "That means the page is answering a small number of very specific questions. Who will treat me and are they qualified. Do they do this procedure often. What will it cost, roughly. How fast can I be seen. Where is it and can I park. What happens if something goes wrong.",
          "A site organised around those questions outperforms a site organised around the clinic's internal structure, which is how most of them are built. Nobody has ever chosen a dentist because the site had a well-written mission statement.",
        ],
        bodyEs: [
          "Antes de escribir una sola sección conviene tener claro qué está haciendo el visitante, porque no es lo que hace el visitante de una tienda en línea.",
          "Rara vez está navegando. Tiene un síntoma, una referencia o una cotización de otro lado, y está comparando dos o tres opciones. La comparación no es de características. Es sobre si esta persona es competente y si el proceso va a ser manejable.",
          "Eso significa que la página está respondiendo un número pequeño de preguntas muy concretas. Quién me va a atender y si está capacitado. Si hacen este procedimiento con frecuencia. Cuánto va a costar, aproximadamente. Qué tan rápido me pueden ver. Dónde está y si hay estacionamiento. Qué pasa si algo sale mal.",
          "Un sitio organizado alrededor de esas preguntas rinde más que uno organizado alrededor de la estructura interna de la clínica, que es como están construidos casi todos. Nadie ha elegido nunca a un dentista porque el sitio tuviera una misión bien redactada.",
        ],
      },
      {
        id: "credenciales",
        heading: "Credentials, visible and specific",
        headingEs: "Credenciales, visibles y específicas",
        body: [
          "This is simultaneously the strongest trust element and a legal obligation, which makes it the easiest decision on the list.",
          "Article 19 of the Reglamento de la Ley General de Salud en Materia de Publicidad requires that professionals practising the activities and specialties covered by the law state, in whatever advertising they do and by whatever medium, the educational institution that issued their title, diploma or certificate and, where applicable, their professional licence number.",
          "So put it where a patient reads it, not in a footer. Full name, specialty, issuing institution, licence number, and for specialists the board or council certification if they hold one.",
          "Give each professional a page rather than a paragraph on a shared team page. Training, years in practice, hospital affiliations, the procedures they actually perform, a real photograph. This page does double duty: it is what a cautious patient reads before booking, and it is the authorship signal that health content needs, which we cover in [E-E-A-T en contenido médico](/blog/eeat-contenido-medico).",
          "Article 18 adds the constraint from the other direction: advertising will not be authorised where it cannot be shown that the establishment has trained personnel and adequate technical and material resources. If you claim a capability on the site, the building should support it.",
        ],
        bodyEs: [
      ...
      {
        id: "paginas-de-servicio",
        heading: "One page per procedure, not one page for all of them",
        headingEs: "Una página por procedimiento, no una página para todos",
        body: [
          "The most common structural mistake is a single services page listing twenty treatments in bullet form. It ranks for nothing and answers no one.",
          "Patients search by procedure, and each procedure carries a different set of worries. Someone researching root canal treatment wants to know about pain and how many visits. Someone researching implants wants to know about bone grafting, healing time and total cost. The same page cannot serve both.",
          "A useful procedure page covers what the treatment is in plain language, who it is appropriate for, what actually happens step by step, how long recovery takes, what it costs or what determines the cost, what the alternatives are, and what the risks are.",
          "That last item is worth arguing for. Clinics resist publishing risks because it feels like discouraging the sale. In practice it is the section that separates a clinic that treats patients as adults from one that is selling. The patient will find the risks elsewhere; the only question is whether they find them from you.",
        ...
        bodyEs: [
          ...
          "Mantén las afirmaciones defendibles. El artículo 18 niega la autorización a la publicidad que ofrezca tratamientos preventivos, curativos o rehabilitatorios cuya eficacia no haya sido comprobada científicamente, así que la redacción de las páginas de procedimiento no es una decisión puramente de marketing.",
        ],
      },
      {
        id: "agendar",
        heading: "Booking: the gap between the button and the appointment",
        headingEs: "Agendar: el hueco entre el botón y la cita",
        body: [
          "Most clinic sites have a contact form that goes to an inbox nobody watches during consultation hours. The form is not the problem. The unwatched inbox is.",
          "Decide what the primary action is and make everything else secondary. For most practices in Mexico that is a phone call or a WhatsApp message, not a form, because patients want confirmation from a person.",
          "Make the phone number a tappable link on mobile and put it in the header, not only on the contact page. A patient with a dental emergency on a phone should never have to scroll.",
          "If you offer online booking, show real availability. A booking widget that produces a request which then requires a callback to confirm is a form wearing a calendar's clothes, and it disappoints the patient at the exact moment they thought they were done.",
          "Whatever the channel, define the response time and staff it. A two-hour response during business hours is a competitive advantage in this category, because the standard is worse than that. The mechanics of automating the first response without touching clinical information are in [WhatsApp para clínicas](/blog/whatsapp-para-clinicas).",
        ],
        bodyEs: [
          "La mayoría de los sitios de clínicas tiene un formulario de contacto que llega a un correo que nadie revisa en horario de consulta. El formulario no es el problema. El correo sin revisar sí.",
          "Decide cuál es la acción principal y haz todo lo demás secundario. Para la mayoría de los consultorios en México eso es una llamada o un mensaje de WhatsApp, no un formulario, porque el paciente quiere confirmación de una persona.",
          "Haz que el número de teléfono sea un enlace tocable en móvil y ponlo en el encabezado, no solo en la página de contacto. Un paciente con una urgencia dental en un teléfono no debería tener que hacer scroll.",
          "Si ofreces agenda en línea, muestra disponibilidad real. Un widget de citas que genera una solicitud que luego requiere una llamada para confirmar es un formulario disfrazado de calendario, y decepciona al paciente justo en el momento en que creyó haber terminado.",
          "Sea cual sea el canal, define el tiempo de respuesta y asígnale personal. Responder en dos horas en horario hábil es una ventaja competitiva en esta categoría, porque el estándar es peor que eso. La mecánica de automatizar la primera respuesta sin tocar información clínica está en [WhatsApp para clínicas](/blog/whatsapp-para-clinicas).",
        ],
      },
      {
        id: "datos",
        heading: "Handling patient data lawfully",
        headingEs: "Tratar datos de pacientes conforme a la ley",
        body: [
          "The moment a form on your site collects a name plus anything about a health concern, you are processing sensitive personal data, and the requirements are stricter than for an ordinary contact form.",
          "Mexico's current data protection law for private parties was published in the Diario Oficial de la Federación on 20 March 2025 and took effect the following day. It replaced the previous framework and dissolved the INAI, transferring its functions in this area to the Secretaría de Anticorrupción y Buen Gobierno. Privacy notices and site copy still naming the INAI are out of date.",
          "Health data falls within sensitive personal data, defined as data touching the most intimate sphere of the holder whose misuse could give rise to discrimination or serious risk, which the law's definition includes present or future health status.",
          "Practically: publish a privacy notice that states who is responsible, what is collected, the purposes, and how the patient exercises their rights. Link it from every form. Do not collect clinical detail in a web form you do not need; a name, a contact method and the reason for the visit is usually enough to book, and everything else belongs in consultation.",
          "Serve the site over HTTPS, which is table stakes, and check where form submissions actually land. A clinic form emailing unencrypted patient concerns to a personal Gmail account is a common and avoidable exposure.",
          "This is a summary, not legal advice. Have your privacy notice reviewed by a lawyer against the law currently in force.",
        ],
        bodyEs: [
          "En el momento en que un formulario de tu sitio recaba un nombre más cualquier cosa sobre un motivo de salud, estás tratando datos personales sensibles, y los requisitos son más estrictos que para un formulario de contacto ordinario.",
          "La ley mexicana vigente de protección de datos en posesión de particulares se publicó en el Diario Oficial de la Federación el 20 de marzo de 2025 y entró en vigor al día siguiente. Sustituyó al marco anterior y extinguió al INAI, transfiriendo sus funciones en esta materia a la Secretaría de Anticorrupción y Buen Gobierno. Los avisos de privacidad y los textos de sitio que siguen nombrando al INAI están desactualizados.",
          "Los datos de salud caen dentro de los datos personales sensibles, definidos como aquellos que afectan la esfera más íntima del titular y cuya utilización indebida puede originar discriminación o conllevar un riesgo grave, definición que comprende el estado de salud presente o futuro.",
          "En la práctica: publica un aviso de privacidad que diga quién es el responsable, qué se recaba, para qué finalidades y cómo ejerce el paciente sus derechos. Enlázalo desde cada formulario. No recabes detalle clínico en un formulario web que no necesitas; un nombre, un medio de contacto y el motivo de la visita suele bastar para agendar, y todo lo demás corresponde a la consulta.",
          "Sirve el sitio por HTTPS, que es lo mínimo, y revisa a dónde llegan realmente los envíos del formulario. Un formulario de clínica que manda motivos de consulta sin cifrar a una cuenta personal de Gmail es una exposición común y evitable.",
          "Esto es un resumen, no asesoría legal. Haz que un abogado revise tu aviso de privacidad contra la ley efectivamente vigente.",
        ],
      },
      {
        id: "tecnico",
        heading: "The technical minimum",
        headingEs: "El mínimo técnico",
        body: [
    ...
    faq: [
      {
        q: "¿Tengo que publicar mi cédula profesional en el sitio?",
        qEn: "Do I have to publish my professional licence number on the site?",
        a: "El artículo 19 del Reglamento de la Ley General de Salud en Materia de Publicidad exige expresar la institución educativa que expidió el título, diploma o certificado y, en su caso, el número de cédula profesional en la publicidad que se realice, cualquiera que sea el medio. El sitio es uno de esos medios. Además es el elemento de confianza más fuerte de la página.",
        aEn: "Article 19 of the health advertising regulation requires stating the educational institution that issued the title, diploma or certificate and, where applicable, the professional licence number in any advertising, in whatever medium. The site is one of those media. It is also the page's strongest trust element.",
      },
      {
        q: "¿Debo publicar precios de los tratamientos?",
        qEn: "Should I publish treatment prices?",
        a: "Publicar rangos con lo que los determina suele funcionar mejor que no publicar nada. El paciente que no encuentra ninguna referencia de precio asume lo peor o llama solo para preguntar el costo, lo que consume tiempo de recepción. Un rango honesto con los factores que lo mueven filtra mejor y prepara la conversación.",
        aEn: "Publishing ranges along with what determines them usually works better than publishing nothing. A patient who finds no price reference assumes the worst, or calls only to ask the cost, which consumes front desk time. An honest range with the factors that move it filters better and sets up the conversation.",
      },
      {
        q: "¿Necesito aviso de privacidad si solo tengo un formulario de contacto?",
        qEn: "Do I need a privacy notice if I only have a contact form?",
        a: "Sí. En el momento en que recabas datos personales eres responsable de su tratamiento, y si el formulario toca un motivo de salud estás tratando datos sensibles. El aviso debe reflejar la ley vigente desde el 21 de marzo de 2025, no la anterior, y no debe citar al INAI, que fue extinguido.",
        aEn: "Yes. The moment you collect personal data you are responsible for processing it, and if the form touches a health concern you are handling sensitive data. The notice must reflect the law in force since 21 March 2025, not the previous one, and should not cite the INAI, which was dissolved.",
      },
      {
        q: "¿Vale la pena una agenda en línea o basta el teléfono?",
        qEn: "Is online booking worth it, or is the phone enough?",
        a: "Depende de si puedes mostrar disponibilidad real. Una agenda que sí reserva un horario reduce fricción. Una que solo genera una solicitud que después requiere llamada para confirmar añade un paso y decepciona. Si no puedes conectar la agenda real, un teléfono bien atendido rinde más.",
        aEn: "It depends on whether you can show real availability. Booking that actually reserves a slot reduces friction. Booking that only generates a request requiring a confirmation call adds a step and disappoints. If you cannot connect the real calendar, a well-answered phone performs better.",
      },
      {
        q: "¿Una página por tratamiento o una sola de servicios?",
        qEn: "One page per treatment or a single services page?",
        a: "Una por tratamiento. Los pacientes buscan por procedimiento y cada procedimiento trae preocupaciones distintas, así que una sola página no puede responderlas. Una lista de veinte viñetas no posiciona para ninguno de los veinte términos ni resuelve la duda de nadie.",
        aEn: "One per treatment. Patients search by procedure and each procedure carries different worries, so a single page cannot answer them. A list of twenty bullets ranks for none of the twenty terms and resolves nobody's question.",
      },
    ],
    schema: {
      keywords: [
        ...
        "patient data privacy mexico",
      ],
      keywordsEs: [
        "sitio web para clinicas",
        "pagina web consultorio medico",
        "diseno web clinicas",
        "aviso de privacidad clinica",
      ],
    },
  },
  {
    ...
    categoryEs: "Marketing Médico",
    excerpt:
      "WhatsApp is where Mexican patients already are. The constraint is that a clinic conversation on it is sensitive personal data sitting on staff phones.",
    excerptEs:
      "WhatsApp es donde los pacientes mexicanos ya están. La restricción es que una conversación de clínica ahí son datos personales sensibles viviendo en los teléfonos del personal.",
    readingTime: 8,
    date: "2026-11-21",
    author: "Aphelion",
    authorRole: "Marketing Team",
    authorRoleEs: "Equipo de Marketing",
    lede: "Ask a Mexican clinic how patients contact them and WhatsApp comes up before the phone. Ask who has access to that account, what happens to the conversations, and whether anyone consented to it, and the answers get vague fast.",
    ledeEs:
      "Pregúntale a una clínica mexicana cómo la contactan los pacientes y WhatsApp sale antes que el teléfono. Pregunta quién tiene acceso a esa cuenta, qué pasa con las conversaciones y si alguien dio su consentimiento, y las respuestas se vuelven vagas rápido.",
    sections: [
      {
        id: "por-que-funciona",
        heading: "Why it works better than a form",
        headingEs: "Por qué funciona mejor que un formulario",
        body: [
          "The advantage is not novelty, it is that the friction is already gone. The patient has the app open, the contact costs one tap, and the reply arrives somewhere they will actually see it.",
          "A web form asks someone to type an email address they check twice a day and then wait without knowing whether it arrived. For a patient with a toothache at nine at night, that gap is where they go and message the next clinic instead.",
          "It also holds the thread. A phone call that ends without booking leaves nothing behind. A WhatsApp conversation is still there tomorrow when the patient decides, which means the follow up has somewhere to happen.",
          "None of that is an argument for putting the whole practice on a personal phone, which is what most clinics have accidentally done.",
        ],
        bodyEs: [
      ...
      {
        id: "datos-sensibles",
        heading: "What you are actually storing",
        headingEs: "Qué estás guardando en realidad",
        body: [
          'A patient writing "hola, tengo una muela infectada y necesito cita" has just given you a name, a phone number and a health condition. Under Mexican law that combination is sensitive personal data.',
          "The framework changed recently and a lot of clinic policy has not caught up. The current federal law on protection of personal data held by private parties was published in the Diario Oficial de la Federación on 20 March 2025 and took effect the following day, replacing the previous law and dissolving the INAI, whose functions in this area moved to the Secretaría de Anticorrupción y Buen Gobierno. Sensitive personal data is defined as data affecting the most intimate sphere of the holder, whose improper use could give rise to discrimination or serious risk, and the definition covers present or future health status.",
          "Separately, NOM-004-SSA3-2012 treats the patient's identity and the information they provide about their condition as confidential information, reinforcing professional secrecy.",
          "The above is a regulatory summary, not legal advice: review with a specialised lawyer what the law in force requires of you. Put those together and the practical questions become concrete. Whose phone is the account on. Who else can read it. What happens to the conversation history when that receptionist leaves. Is there a privacy notice the patient ever saw. Most clinics cannot answer any of these, and the risk is not theoretical: a staff phone with two years of patient conversations is a data breach in a pocket.",
        ],
        bodyEs: [
          'Un paciente que escribe "hola, tengo una muela infectada y necesito cita" acaba de darte un nombre, un teléfono y un padecimiento. Conforme a la ley mexicana esa combinación son datos personales sensibles.',
          "El marco cambió hace poco y buena parte de las políticas de las clínicas no se ha puesto al día. La ley federal vigente de protección de datos personales en posesión de particulares se publicó en el Diario Oficial de la Federación el 20 de marzo de 2025 y entró en vigor al día siguiente, sustituyendo a la anterior y extinguiendo al INAI, cuyas funciones en esta materia pasaron a la Secretaría de Anticorrupción y Buen Gobierno. Los datos personales sensibles se definen como aquellos que afectan la esfera más íntima del titular y cuya utilización indebida puede originar discriminación o conllevar un riesgo grave, y la definición comprende el estado de salud presente o futuro.",
          "Por separado, la NOM-004-SSA3-2012 trata la identidad del paciente y la información que proporciona sobre su padecimiento como información confidencial, reforzando el secreto profesional.",
          "Lo anterior es un resumen normativo, no asesoría legal: revisa con un abogado especializado qué te exige la ley vigente. Junta las dos cosas y las preguntas prácticas se vuelven concretas. En qué teléfono está la cuenta. Quién más puede leerla. Qué pasa con el historial de conversaciones cuando esa recepcionista se va. Si existe un aviso de privacidad que el paciente haya visto alguna vez. La mayoría de las clínicas no puede responder ninguna, y el riesgo no es teórico: un teléfono del personal con dos años de conversaciones de pacientes es una fuga de datos en un bolsillo.",
        ],
      },
      {
        id: "separar",
        heading: "Separate the account from the person",
        headingEs: "Separa la cuenta de la persona",
        body: [
          "The first fix is structural and costs nothing but a decision.",
          "The clinic's WhatsApp should belong to the clinic, on a number the clinic controls, not on the receptionist's personal line. When someone leaves, the number and the history stay.",
          "Use the business version of the app rather than the consumer one, so you get a business profile, saved replies and labels, and a boundary between the practice's messages and someone's family chat.",
          "Set business hours in the app and an away message that says when you will reply. A patient who knows they will hear back at eight tomorrow waits; a patient who hears nothing messages a competitor.",
          "Write down who has access and remove it when they leave. This sounds like bureaucracy for a three-person practice, and it is the single control that most often turns out to have been missing.",
        ],
        bodyEs: [
          "El primer arreglo es estructural y no cuesta más que una decisión.",
          "El WhatsApp de la clínica debe ser de la clínica, en un número que la clínica controla, no en la línea personal de la recepcionista. Cuando alguien se va, el número y el historial se quedan.",
          "Usa la versión de negocios de la aplicación en vez de la de consumidor, para tener perfil de negocio, respuestas guardadas y etiquetas, y una frontera entre los mensajes del consultorio y el chat familiar de alguien.",
          "Configura el horario de atención en la aplicación y un mensaje de ausencia que diga cuándo vas a responder. Un paciente que sabe que le contestan mañana a las ocho espera; un paciente que no recibe nada le escribe a la competencia.",
          "Deja por escrito quién tiene acceso y quítalo cuando esa persona se va. Suena a burocracia para un consultorio de tres personas, y es el control que con más frecuencia resulta que faltaba.",
        ],
      },
      {
        id: "que-automatizar",
        heading: "What to automate, and the hard line",
        headingEs: "Qué automatizar, y la línea que no se cruza",
        body: [
          "Automation earns its place on the repetitive half of the conversation, which in a clinic is most of it.",
          "Safe to automate: greeting and hours, location and parking, what the consultation costs, what to bring, which insurance you take, appointment confirmations and reminders, and collecting the name and preferred time so a human can confirm.",
          "The line is clinical content. An automated system should never interpret a symptom, suggest a diagnosis, recommend a treatment, adjust a medication, or handle anything that sounds like an emergency. Those go to a person, immediately and by a defined route.",
          "That last one deserves a rule of its own. Build an explicit escalation for emergency language, and make the automated response tell the patient to call a number or go to urgencies rather than wait for a reply. A bot that cheerfully offers a Tuesday appointment to someone describing chest pain is the failure mode to design against.",
          'Keep clinical detail out of automated messages in both directions. A reminder that says "su cita del jueves 10:00" is fine. One that says "su cita para biopsia del jueves" has put a diagnosis on a lock screen that may not be the patient\'s alone.',
          "If you are building this on a website widget rather than only on WhatsApp, the same constraints apply and the same escalation has to exist. That is the pattern we implement in [Agente IA](/servicios/agente-ia).",
        ],
        bodyEs: [
          "La automatización se gana su lugar en la mitad repetitiva de la conversación, que en una clínica es casi toda.",
          "Seguro de automatizar: saludo y horarios, ubicación y estacionamiento, cuánto cuesta la consulta, qué llevar, qué seguros aceptas, confirmaciones y recordatorios de cita, y recabar el nombre y el horario preferido para que un humano confirme.",
          "La línea es el contenido clínico. Un sistema automatizado nunca debe interpretar un síntoma, sugerir un diagnóstico, recomendar un tratamiento, ajustar un medicamento ni atender nada que suene a urgencia. Eso va a una persona, de inmediato y por una ruta definida.",
          "Ese último punto merece regla propia. Construye una escalación explícita para lenguaje de urgencia, y haz que la respuesta automática le diga al paciente que llame a un número o acuda a urgencias en lugar de esperar contestación. Un bot que le ofrece con entusiasmo una cita el martes a alguien que describe dolor en el pecho es el modo de falla contra el que hay que diseñar.",
          'Mantén el detalle clínico fuera de los mensajes automáticos en ambas direcciones. Un recordatorio que dice "su cita del jueves 10:00" está bien. Uno que dice "su cita para biopsia del jueves" acaba de poner un diagnóstico en una pantalla bloqueada que quizá no es solo del paciente.',
          "Si vas a construir esto en un widget del sitio y no solo en WhatsApp, aplican las mismas restricciones y tiene que existir la misma escalación. Ese es el patrón que implementamos en [Agente IA](/servicios/agente-ia).",
        ],
      },
      {
        id: "recordatorios",
        heading: "Reminders are the highest-return use",
        headingEs: "Los recordatorios son el uso de mayor retorno",
        body: [
          "Of everything WhatsApp can do for a clinic, appointment reminders are the least glamorous and the most valuable, because a no-show is a slot that generated nothing and cannot be recovered.",
          "The useful pattern is a confirmation when the appointment is booked and a reminder the day before that lets the patient reply to confirm, reschedule or cancel. The reply is the part that matters: a reminder the patient cannot act on only reduces surprise, while one they can act on lets you refill the slot.",
          "Make cancelling easy. Clinics resist this on the theory that friction prevents cancellations. It does not; it converts cancellations into no-shows, which are strictly worse because you find out when the chair is empty.",
          "Track the no-show rate before and after. It is one of the few marketing-adjacent changes in a clinic with a clean before and after number, and it is the one that pays for the rest of the work.",
        ],
        bodyEs: [
          "De todo lo que WhatsApp puede hacer por una clínica, los recordatorios de cita son lo menos vistoso y lo más valioso, porque una inasistencia es un espacio que no generó nada y no se recupera.",
          "El patrón útil es una confirmación cuando se agenda la cita y un recordatorio el día anterior que permita al paciente responder para confirmar, reprogramar o cancelar. La respuesta es la parte que importa: un recordatorio sobre el que el paciente no puede actuar solo reduce la sorpresa, mientras que uno accionable te deja volver a llenar el espacio.",
          "Haz que cancelar sea fácil. Las clínicas se resisten con la teoría de que la fricción previene cancelaciones. No lo hace; convierte cancelaciones en inasistencias, que son estrictamente peores porque te enteras cuando el sillón está vacío.",
          "Mide la tasa de inasistencia antes y después. Es uno de los pocos cambios cercanos al marketing en una clínica con un número limpio de antes y después, y es el que paga el resto del trabajo.",
        ],
      },
      {
        id: "errores",
        heading: "The mistakes that cause the trouble",
        headingEs: "Los errores que causan los problemas",
        body: [
          "Broadcasting promotions to a patient list. A list of your patients is a list of people with health conditions, and a mass message to it is both a data protection problem and the fastest way to get blocked as spam. Send to patients who asked to hear from you, about things they asked about.",
          "Leaving the account on a personal phone. Covered above, and it remains the most common single failure.",
          "Answering clinically over chat because it is convenient. A written treatment recommendation without an examination is a liability, and it is one the clinician usually gives away for free.",
          "No privacy notice. If patients contact you through this channel, the notice should say so and be reachable from the profile and the site.",
          "No response time. An unanswered WhatsApp is worse than no WhatsApp, because the patient saw the two grey ticks and drew a conclusion about the practice.",
        ],
        bodyEs: [
          "Difundir promociones a una lista de pacientes. Una lista de tus pacientes es una lista de personas con padecimientos, y un mensaje masivo a ella es a la vez un problema de protección de datos y la vía más rápida a que te bloqueen por spam. Escríbele a pacientes que pidieron saber de ti, sobre lo que preguntaron.",
          "Dejar la cuenta en un teléfono personal. Ya cubierto, y sigue siendo la falla individual más común.",
          "Responder clínicamente por chat porque es cómodo. Una recomendación de tratamiento por escrito sin exploración es una responsabilidad, y es una que el clínico normalmente regala.",
          "No tener aviso de privacidad. Si los pacientes te contactan por este canal, el aviso debe decirlo y ser alcanzable desde el perfil y desde el sitio.",
          "No tener tiempo de respuesta. Un WhatsApp sin contestar es peor que no tener WhatsApp, porque el paciente vio las dos palomitas grises y sacó una conclusión sobre el consultorio.",
        ],
      },
    ],
    gradient: "from-neutral-800 to-zinc-950",
    faq: [
      {
        q: "¿Puedo usar mi WhatsApp personal para la clínica?",
        qEn: "Can I use my personal WhatsApp for the clinic?",
        a: "No conviene. Las conversaciones contienen datos personales sensibles y el número queda ligado a una persona, no a la clínica. Cuando esa persona se va, se va el historial y el canal por donde los pacientes te buscan. Usa un número de la clínica con la versión de negocios y controla quién tiene acceso.",
        aEn: "It is inadvisable. The conversations contain sensitive personal data and the number is tied to a person, not the clinic. When that person leaves, so does the history and the channel patients use to reach you. Use a clinic number with the business version and control who has access.",
      },
      {
        q: "¿Necesito consentimiento del paciente para escribirle por WhatsApp?",
        qEn: "Do I need patient consent to message them on WhatsApp?",
        a: "Necesitas un aviso de privacidad que informe que usas ese canal y para qué finalidades, y el tratamiento de datos sensibles exige consentimiento del titular. Un paciente que te escribe primero para agendar es distinto de una lista a la que le mandas promociones sin que lo hayan pedido. Confirma tu caso con un abogado contra la ley vigente desde marzo de 2025.",
        aEn: "You need a privacy notice stating that you use the channel and for what purposes, and processing sensitive data requires the holder's consent. A patient who messages you first to book is different from a list you send unsolicited promotions to. Confirm your situation with a lawyer against the law in force since March 2025.",
      },
      {
        q: "¿Puede un bot dar orientación clínica si aclara que no sustituye la consulta?",
        qEn: "Can a bot give clinical guidance if it says it does not replace a consultation?",
        a: "No. El descargo no cambia lo que ocurrió: un sistema automatizado interpretó un síntoma sin exploración. Limita la automatización a horarios, ubicación, costos, requisitos y agendado, y define una escalación inmediata a una persona para cualquier lenguaje clínico o de urgencia.",
        aEn: "No. The disclaimer does not change what happened: an automated system interpreted a symptom without an examination. Limit automation to hours, location, costs, requirements and booking, and define immediate escalation to a person for any clinical or emergency language.",
      },
      {
        q: "¿Qué debe decir un recordatorio de cita?",
        qEn: "What should an appointment reminder say?",
        a: "Fecha, hora, dirección, qué llevar y una forma fácil de confirmar, reprogramar o cancelar. Nada del motivo clínico. Un recordatorio que nombra el procedimiento expone un diagnóstico en una pantalla que puede ver alguien más.",
        aEn: "Date, time, address, what to bring and an easy way to confirm, reschedule or cancel. Nothing about the clinical reason. A reminder naming the procedure exposes a diagnosis on a screen someone else may see.",
      },
      {
        q: "¿Puedo mandar promociones a mis pacientes por WhatsApp?",
        qEn: "Can I send promotions to my patients over WhatsApp?",
        a: "Con mucho cuidado y solo a quienes lo pidieron. Una lista de pacientes es una lista de personas con condiciones de salud, y usarla para promoción masiva es a la vez un riesgo de protección de datos y la manera más rápida de que te reporten como spam.",
        aEn: "Only with great care and only to people who asked for it. A patient list is a list of people with health conditions, and using it for mass promotion is both a data protection risk and the fastest way to get reported as spam.",
      },
    ],
    schema: {
      keywords: [
        ...
        "patient messaging compliance",
        "clinic automation",
      ],
      keywordsEs: [
        "whatsapp para clinicas",
        "recordatorios de cita whatsapp",
        "agendar citas whatsapp",
        "automatizacion consultorio",
      ],
    },
  },
  {
    ...
    categoryEs: "Marketing Médico",
    excerpt:
      "The before-and-after photo, the comment section diagnosis and the miracle-result caption are the three posts most likely to cause a clinic real trouble.",
    excerptEs:
      "La foto de antes y después, el diagnóstico en comentarios y el pie de foto de resultado milagroso son las tres publicaciones con más probabilidad de causarle a una clínica un problema real.",
    readingTime: 8,
    date: "2026-11-24",
    author: "Aphelion",
    authorRole: "Marketing Team",
    authorRoleEs: "Equipo de Marketing",
    lede: "A physician's social account sits on top of three sets of rules at once: the platform's, the profession's confidentiality duty, and Mexican health advertising regulation. Most clinic accounts are run as though only the first exists, and usually not even that one.",
    ledeEs:
      "La cuenta de un médico en redes vive sobre tres conjuntos de reglas a la vez: las de la plataforma, el deber de confidencialidad de la profesión y la regulación mexicana de publicidad sanitaria. Casi todas las cuentas de clínicas se manejan como si solo existiera el primero, y con frecuencia ni ese.",
    sections: [
      {
        id: "para-que-sirve",
        heading: "Be clear what the account is for",
        headingEs: "Ten claro para qué es la cuenta",
        body: [
          "A clinic account can do one of three jobs well and all three badly.",
          "It can build familiarity, so that when someone needs a specialist your name is the one they already recognise. It can answer the questions patients have before they book, which shortens the consultation and filters who arrives. Or it can be a direct acquisition channel, which is the hardest of the three and the one most clinics assume they are doing.",
          "Familiarity is usually the honest goal for a practice, and it is undervalued because it does not produce attributable bookings. Someone who followed you for eight months and then called is recorded as a phone call from nowhere.",
          "Decide which one you are doing, because the content differs. An account built for familiarity posts the clinician thinking out loud. An account built to answer pre-booking questions posts the six things every patient asks. An acquisition account needs offers and a booking path, and it needs to survive the advertising rules that come with it.",
        ],
        bodyEs: [
          "Una cuenta de clínica puede hacer bien uno de tres trabajos, y mal los tres.",
          "Puede construir familiaridad, para que cuando alguien necesite un especialista tu nombre sea el que ya reconoce. Puede responder las preguntas que los pacientes tienen antes de agendar, lo que acorta la consulta y filtra quién llega. O puede ser un canal directo de captación, que es el más difícil de los tres y el que casi todas las clínicas suponen que están haciendo.",
          "La familiaridad suele ser el objetivo honesto para un consultorio, y está subvalorada porque no produce citas atribuibles. Alguien que te siguió ocho meses y luego llamó queda registrado como una llamada que salió de la nada.",
          "Decide cuál estás haciendo, porque el contenido cambia. Una cuenta construida para familiaridad publica al clínico pensando en voz alta. Una construida para responder dudas previas publica las seis cosas que todo paciente pregunta. Una de captación necesita ofertas y una ruta de agendado, y necesita sobrevivir a las reglas de publicidad que eso trae.",
        ],
      },
      {
        id: "antes-y-despues",
        heading: "The before-and-after photo",
        headingEs: "La foto de antes y después",
        body: [
          "This is the most requested post type in dentistry and aesthetics, and the one that most often gets published without the paperwork that makes it lawful.",
          "NOM-004-SSA3-2012 is explicit: for purposes of medical literature, teaching, research or photographs that allow identifying the patient, publishing or disclosing personal data from the clinical file requires the patient's written authorisation, and requires adopting the necessary measures so the patient cannot be identified.",
          "Two obligations, not one. Written authorisation, and de-identification. Verbal consent in the chair does not satisfy the first. A cropped mouth is often not enough for the second, because a distinctive dental arrangement, a visible tattoo, a background detail in your own clinic, or the post's date next to a patient's own social activity can all identify someone in a small city.",
          "Practical version: a written, signed authorisation that names the specific use, including social media and website, kept in the file. Photographs framed so that identification is not possible. No names, no dates of treatment, and no replies in the comments confirming who it was.",
          "Also relevant: article 18 of the health advertising regulation withholds authorisation from advertising that offers treatments whose efficacy has not been scientifically proven. A before-and-after presented as a typical outcome, when it is the best case you have, drifts toward exactly that.",
          "If the authorisation is not in the file, do not post it. The single image is not worth the complaint.",
        ],
        bodyEs: [
          "Es el tipo de publicación más pedido en odontología y estética, y el que con más frecuencia se publica sin el papel que lo hace lícito.",
          "La NOM-004-SSA3-2012 es explícita: para efectos de literatura médica, docencia, investigación o fotografías que permitan identificar al paciente, publicar o divulgar datos personales del expediente clínico requiere autorización por escrito del paciente y exige adoptar las medidas necesarias para que el paciente no pueda ser identificado.",
          "Son dos obligaciones, no una. Autorización escrita, y que no se pueda identificar. El consentimiento verbal en el sillón no cumple la primera. Una boca recortada muchas veces no basta para la segunda, porque una disposición dental distintiva, un tatuaje visible, un detalle de fondo de tu propia clínica o la fecha del post junto a la actividad social del propio paciente pueden identificar a alguien en una ciudad chica.",
          "Versión práctica: una autorización firmada por escrito que nombre el uso específico, incluidas redes sociales y sitio web, guardada en el expediente. Fotografías encuadradas de modo que la identificación no sea posible. Sin nombres, sin fechas de tratamiento y sin respuestas en comentarios confirmando de quién se trata.",
          "También relevante: el artículo 18 del reglamento de publicidad sanitaria niega la autorización a la publicidad que ofrezca tratamientos cuya eficacia no haya sido comprobada científicamente. Un antes y después presentado como resultado típico, cuando es el mejor caso que tienes, deriva justo hacia eso.",
          "Si la autorización no está en el expediente, no lo publiques. Una imagen no vale la queja.",
        ],
      },
      {
        id: "comentarios",
        heading: "The comment section is not a consultation",
        headingEs: "La sección de comentarios no es una consulta",
        body: [
          "Post anything clinical and within an hour someone will describe their symptoms and ask what they should do. The instinct to help is the right instinct and the wrong channel.",
          "Answering with anything resembling a diagnosis or a treatment recommendation, without an examination or a history, exposes the clinician and gives the person advice built on a paragraph. It also happens in public, where the next reader takes it as general guidance.",
          "The reply that works is short and consistent: this needs to be examined properly, here is how to book, and if it is urgent here is what to do now. Say it the same way every time so the account has a visible policy rather than a mood.",
          "Move the specifics to a private channel, and even there the same limit applies. A written recommendation in a direct message is still a recommendation without an examination. The constraints are the same ones covered in [WhatsApp para clínicas](/blog/whatsapp-para-clinicas).",
          "Do not confirm in public that someone is your patient. A reply thanking a commenter for their visit last week has disclosed care, and the duty of confidentiality does not evaporate because they commented first.",
        ],
        bodyEs: [
          "Publica cualquier cosa clínica y en una hora alguien describe sus síntomas y pregunta qué debería hacer. El impulso de ayudar es el impulso correcto y el canal equivocado.",
          "Responder con algo parecido a un diagnóstico o a una recomendación de tratamiento, sin exploración ni historia clínica, expone al clínico y le da a la persona un consejo construido sobre un párrafo. Además pasa en público, donde el siguiente lector lo toma como orientación general.",
          "La respuesta que funciona es corta y consistente: esto necesita valorarse en consulta, así se agenda, y si es urgente esto es lo que hay que hacer ahora. Dilo igual siempre, para que la cuenta tenga una política visible y no un estado de ánimo.",
          "Lleva lo específico a un canal privado, y ahí aplica el mismo límite. Una recomendación escrita en un mensaje directo sigue siendo una recomendación sin exploración. Las restricciones son las mismas que cubrimos en [WhatsApp para clínicas](/blog/whatsapp-para-clinicas).",
          "No confirmes en público que alguien es tu paciente. Una respuesta agradeciéndole a un comentarista su visita de la semana pasada ya divulgó la atención, y el deber de confidencialidad no se evapora porque la persona comentó primero.",
        ],
      },
      {
        id: "credencial",
        heading: "Your credential belongs in the profile",
        headingEs: "Tu credencial va en el perfil",
        body: [
          "Article 19 of the health advertising regulation requires that professional advertising state the institution that issued the title, diploma or certificate and, where applicable, the professional licence number, in whatever advertising medium is used.",
          "A social profile promoting a practice is an advertising medium. The bio is where this goes: full name, specialty, issuing institution, licence number.",
          "It is also the fastest credibility signal available on a platform full of people who are not qualified. In categories like aesthetics and nutrition, where unlicensed accounts are abundant, publishing the credential distinguishes you at zero cost.",
          "Add it to the profile once and it applies to everything you post, which is easier than trying to fit it into individual captions.",
        ],
        bodyEs: [
          "El artículo 19 del reglamento de publicidad sanitaria exige que la publicidad profesional exprese la institución que expidió el título, diploma o certificado y, en su caso, el número de cédula profesional, cualquiera que sea el medio publicitario utilizado.",
          "Un perfil social que promueve un consultorio es un medio publicitario. La biografía es donde va esto: nombre completo, especialidad, institución que expidió el título, número de cédula.",
          "Además es la señal de credibilidad más rápida disponible en una plataforma llena de gente que no está capacitada. En categorías como estética y nutrición, donde abundan las cuentas sin cédula, publicar la credencial te distingue a costo cero.",
          "Agrégalo al perfil una vez y aplica a todo lo que publiques, que es más fácil que intentar meterlo en cada pie de foto.",
        ],
      },
      {
        id: "que-publicar",
        heading: "What to post when you have twenty minutes a week",
        headingEs: "Qué publicar cuando tienes veinte minutos a la semana",
        body: [
          "Consistency beats production value in this category, and most clinics fail on consistency because they planned for production value.",
          "The questions you answer daily in consultation. Write down the six most frequent for a week and you have six weeks of posts, in the patient's own words, on topics with demonstrated demand.",
          "The process, demystified. What actually happens during the procedure, what the recovery is like, what the patient will feel. Anxiety about the unknown is a real reason people postpone treatment.",
          "The clinic itself: the room, the equipment, the team. It is the cheapest content you have and it does more than stock photography, because the patient is trying to picture where they will be.",
          "Corrections of common misinformation, stated carefully and without contempt for the person who believed it.",
          "What to skip: generic health-day graphics that any account could post, motivational quotes over stock images, and anything promising a result. The first two are invisible and the third is the one that draws regulatory attention.",
        ],
        bodyEs: [
          "La constancia le gana a la producción en esta categoría, y casi todas las clínicas fallan en constancia porque planearon para producción.",
          "Las preguntas que respondes a diario en consulta. Anota las seis más frecuentes durante una semana y ya tienes seis semanas de publicaciones, en las palabras del propio paciente, sobre temas con demanda demostrada.",
          "El proceso, desmitificado. Qué pasa realmente durante el procedimiento, cómo es la recuperación, qué va a sentir el paciente. La ansiedad ante lo desconocido es una razón real por la que la gente pospone tratamientos.",
          "La clínica misma: el consultorio, el equipo, el personal. Es el contenido más barato que tienes y hace más que la fotografía de banco, porque el paciente está tratando de imaginarse dónde va a estar.",
          "Correcciones de desinformación común, dichas con cuidado y sin desprecio por quien la creyó.",
          "Qué saltarse: las gráficas genéricas de día mundial de algo que cualquier cuenta podría publicar, las frases motivacionales sobre imágenes de banco y cualquier cosa que prometa un resultado. Las dos primeras son invisibles y la tercera es la que atrae atención normativa.",
        ],
      },
      {
        id: "anuncios",
        heading: "If you are going to advertise on social",
        headingEs: "Si vas a anunciar en redes",
        body: [
          "Paid social adds a fourth rulebook, and it interacts badly with health.",
    ...
    faq: [
      {
        ...
        qEn: "Can I post before and after photos?",
        a: "Solo con autorización por escrito del paciente y encuadradas de modo que no pueda ser identificado. La NOM-004-SSA3-2012 exige ambas cosas: la autorización escrita y las medidas para que no se le identifique. El consentimiento verbal no cumple, y recortar la boca a veces no basta en una ciudad chica.",
        aEn: "Only with the patient's written authorisation and framed so they cannot be identified. NOM-004-SSA3-2012 requires both: written authorisation and measures preventing identification. Verbal consent does not satisfy it, and cropping to the mouth is sometimes not enough in a small city.",
      },
      {
        q: "¿Puedo responder dudas médicas en los comentarios?",
        qEn: "Can I answer medical questions in the comments?",
        a: "Orientación general sí, diagnóstico o recomendación de tratamiento no. Sin exploración ni historia clínica, cualquier indicación específica expone al clínico y le da a la persona un consejo construido sobre un párrafo. Ten una respuesta estándar que invite a valorar en consulta y que indique qué hacer si es urgente.",
        aEn: "General orientation yes, diagnosis or treatment recommendation no. Without an examination or history, any specific instruction exposes the clinician and gives the person advice built on a paragraph. Keep a standard reply inviting an in-person assessment and stating what to do if it is urgent.",
      },
      {
        q: "¿Tengo que poner mi cédula en el perfil de redes?",
        qEn: "Do I have to put my licence number in my social profile?",
        a: "El artículo 19 del reglamento de publicidad sanitaria exige expresar la institución que expidió el título y, en su caso, la cédula profesional, cualquiera que sea el medio publicitario. Un perfil que promueve tu consultorio es uno de esos medios. Además te distingue en categorías donde abundan las cuentas sin credencial.",
        aEn: "Article 19 of the health advertising regulation requires stating the issuing institution and, where applicable, the professional licence number, in whatever advertising medium. A profile promoting your practice is one of those media. It also distinguishes you in categories full of uncredentialed accounts.",
      },
      {
        q: "¿Con qué frecuencia debo publicar?",
        qEn: "How often should I post?",
        a: "Con la frecuencia que puedas sostener durante un año. Dos publicaciones semanales mantenidas doce meses superan a publicar a diario durante seis semanas y luego desaparecer. La constancia es la variable que las clínicas subestiman y la que determina si la cuenta construye algo.",
        aEn: "As often as you can sustain for a year. Two posts a week held for twelve months beats daily posting for six weeks and then disappearing. Consistency is the variable clinics underestimate and the one that determines whether the account builds anything.",
      },
      {
        q: "¿Sirve pagar publicidad en redes para una clínica?",
        qEn: "Is paid social advertising worth it for a clinic?",
        a: "Puede servir, con un encuadre distinto al habitual. No puedes segmentar por padecimiento ni dirigirte al estado de salud del lector, así que la campaña tiene que anunciar el consultorio y el servicio. Y siguen aplicando el artículo 19 sobre la credencial y el artículo 18 sobre afirmaciones de eficacia.",
        aEn: "It can work, with a different framing than usual. You cannot target by condition or address the reader's health status, so the campaign has to advertise the practice and the service. Article 19 on credentials and article 18 on efficacy claims still apply.",
      },
    ],
    schema: {
      keywords: [
        ...
        "clinic social content",
      ],
      keywordsEs: [
        "redes sociales para doctores",
        "instagram para medicos",
        "fotos antes y despues pacientes",
        "contenido para clinicas",
      ],
    },
  },
  {
    ...
    categoryEs: "Marketing Médico",
    excerpt:
      "The percentage-of-revenue rule you keep reading is guesswork applied to your clinic. Here is the arithmetic that produces a defensible number from your own figures.",
    excerptEs:
      "La regla del porcentaje de ingresos que sigues leyendo es una suposición aplicada a tu clínica. Aquí está la aritmética que produce un número defendible con tus propios datos.",
    readingTime: 8,
    date: "2026-11-26",
    author: "Aphelion",
    authorRole: "Marketing Team",
    authorRoleEs: "Equipo de Marketing",
    lede: "Search this question and you get a percentage of revenue, stated confidently and sourced from nowhere. The number is unusable because it ignores the two things that actually determine the answer: what a patient is worth to you, and how many you are missing.",
    ledeEs:
      "Busca esta pregunta y obtienes un porcentaje de los ingresos, dicho con seguridad y sin fuente. El número es inservible porque ignora las dos cosas que de verdad determinan la respuesta: cuánto vale un paciente para ti y cuántos estás dejando de atender.",
    sections: [
      {
        id: "por-que-los-porcentajes-fallan",
        heading: "Why the percentage rules fail here",
        headingEs: "Por qué las reglas de porcentaje fallan aquí",
        body: [
          "A percentage of revenue is a budgeting convention borrowed from industries where the unit economics are roughly uniform. Medicine is not one of those.",
          "Two dental practices on the same street can have patient values that differ by an order of magnitude, because one does hygiene and fillings and the other does full-arch implants. The same percentage applied to both produces a budget that is wasteful in one and negligible in the other.",
          "The percentage also says nothing about capacity, which is the constraint that actually binds in a clinic. Marketing spend that fills chairs already full generates waiting lists and irritation, not revenue.",
          "We are not going to publish a benchmark number here, because we do not have verified Mexican data on medical marketing spend by specialty, and inventing one would be worse than useless: you would build a budget on it. What follows is the arithmetic that produces your number from figures you already have.",
        ],
        bodyEs: [
          "Un porcentaje de los ingresos es una convención presupuestal tomada de industrias donde la economía unitaria es más o menos uniforme. La medicina no es una de ellas.",
          "Dos consultorios dentales en la misma calle pueden tener valores de paciente que difieren en un orden de magnitud, porque uno hace higiene y resinas y el otro hace rehabilitación completa con implantes. El mismo porcentaje aplicado a ambos produce un presupuesto derrochador en uno y despreciable en el otro.",
          "El porcentaje tampoco dice nada de la capacidad, que es la restricción que de verdad amarra en una clínica. Gasto de marketing que llena sillones ya ocupados genera listas de espera e irritación, no ingresos.",
          "No vamos a publicar aquí una cifra de referencia, porque no tenemos datos mexicanos verificados de gasto en marketing médico por especialidad, e inventar una sería peor que inútil: construirías un presupuesto sobre ella. Lo que sigue es la aritmética que produce tu número a partir de datos que ya tienes.",
        ],
      },
      {
        id: "valor-del-paciente",
        heading: "Start with what a patient is worth",
        headingEs: "Empieza por cuánto vale un paciente",
        body: [
      ...
      {
        id: "capacidad",
        heading: "Then find out how much room you actually have",
        headingEs: "Después averigua cuánto espacio tienes en realidad",
        body: [
          "The budget is capped by capacity, not by ambition. Before spending anything, count the empty slots.",
          "Take the appointments a full week would hold at your current staffing, subtract what you actually schedule, and you have the gap marketing is being hired to fill. Multiply that gap by the value of a patient and you have the maximum revenue marketing can produce this month. Your budget is a fraction of that ceiling, not of your total revenue.",
          "Two clinics with identical revenue can have completely different correct budgets. One running at ninety percent capacity has almost nothing to gain and should be raising prices or adding hours. One running at fifty percent has a large, well-defined opportunity.",
          "If the gap is small, the answer is usually not more marketing. It is pricing, scheduling efficiency, or reducing no-shows, and the last of those is cheaper than acquisition by a wide margin. We cover the reminder mechanics in [WhatsApp para clínicas](/blog/whatsapp-para-clinicas).",
          "Also check the bottleneck is really demand. A clinic that gets plenty of calls and converts few of them has a front desk problem, and spending on ads pours more calls into the same leak.",
        ],
        bodyEs: [
          "El presupuesto lo topa la capacidad, no la ambición. Antes de gastar nada, cuenta los espacios vacíos.",
          "Toma las citas que cabrían en una semana llena con tu personal actual, réstale las que efectivamente agendas, y tienes el hueco que el marketing viene a llenar. Multiplica ese hueco por el valor de un paciente y tienes el ingreso máximo que el marketing puede producir este mes. Tu presupuesto es una fracción de ese techo, no de tus ingresos totales.",
          "Dos clínicas con ingresos idénticos pueden tener presupuestos correctos completamente distintos. Una que opera al noventa por ciento de capacidad casi no tiene nada que ganar y debería estar subiendo precios o agregando horas. Una que opera al cincuenta tiene una oportunidad grande y bien definida.",
          "Si el hueco es chico, la respuesta normalmente no es más marketing. Es precio, eficiencia de agenda o reducir inasistencias, y lo último es más barato que la captación por un margen amplio. Cubrimos la mecánica de recordatorios en [WhatsApp para clínicas](/blog/whatsapp-para-clinicas).",
          "Verifica también que el cuello de botella sea de verdad la demanda. Una clínica que recibe muchas llamadas y convierte pocas tiene un problema de recepción, y gastar en anuncios echa más llamadas por la misma fuga.",
        ],
      },
      {
        id: "la-aritmetica",
        heading: "The calculation, in order",
        headingEs: "El cálculo, en orden",
        body: [
          "Five steps, all using numbers from your own practice.",
          "One: value of an enquiry. Value of an accepted treatment plan, times the share of enquiries that become accepted plans.",
          "Two: your acceptable cost per enquiry. Decide what fraction of the enquiry's value you are willing to pay to acquire it. A clinic wanting a three-to-one return pays up to a third; one funding aggressive growth may accept less margin. This is a business decision, not a formula.",
          "Three: how many enquiries you need. The capacity gap divided by the share of enquiries that turn into attending patients.",
          "Four: the budget. Enquiries needed, times acceptable cost per enquiry.",
          "Five: check it against reality after one month. If your actual cost per enquiry comes in far above what you set in step two, the honest conclusion is that this channel does not work at your patient value, not that you need to spend more until it does.",
          "The output of this is a number you can defend to yourself. It also tells you what has to be true for the spend to make sense, which is the more useful product.",
        ],
        bodyEs: [
          "Cinco pasos, todos con números de tu propio consultorio.",
          "Uno: valor de una consulta entrante. Valor de un plan de tratamiento aceptado, por la proporción de consultas que se vuelven planes aceptados.",
          "Dos: tu costo por consulta aceptable. Decide qué fracción del valor de la consulta estás dispuesto a pagar por conseguirla. Una clínica que quiere un retorno de tres a uno paga hasta un tercio; una que financia crecimiento agresivo puede aceptar menos margen. Esto es una decisión de negocio, no una fórmula.",
          "Tres: cuántas consultas necesitas. El hueco de capacidad entre la proporción de consultas que se convierten en pacientes que asisten.",
          "Cuatro: el presupuesto. Consultas necesarias, por costo por consulta aceptable.",
          "Cinco: contrástalo con la realidad al mes. Si tu costo por consulta real sale muy por encima de lo que fijaste en el paso dos, la conclusión honesta es que ese canal no funciona a tu valor de paciente, no que necesitas gastar más hasta que funcione.",
          "El resultado es un número que puedes defenderte a ti mismo. Además te dice qué tendría que ser cierto para que el gasto tenga sentido, que es el producto más útil.",
        ],
      },
      {
        id: "donde-ponerlo",
        heading: "Where the first peso should go",
      ...
      {
        id: "senales",
        heading: "Signs you are spending wrong",
        headingEs: "Señales de que estás gastando mal",
        body: [
          "You cannot say where last month's new patients came from. This is the most common condition and it makes every other question unanswerable.",
          "You are measuring clicks and impressions rather than appointments. In this category the conversion is usually a phone call, and a campaign optimised on clicks optimises the wrong end.",
          "You are paying a retainer for activity rather than outcomes, with a monthly report full of reach and engagement and nothing about patients.",
          "You are spending on acquisition while the no-show rate sits untouched. Recovering an existing booking is cheaper than buying a new one, every time.",
          "You increased the budget because results were poor. If the cost per enquiry is above what your patient value supports, more volume at the same cost makes the loss bigger, not smaller.",
        ],
        bodyEs: [
          "No puedes decir de dónde vinieron los pacientes nuevos del mes pasado. Es la condición más común y vuelve incontestable cualquier otra pregunta.",
          "Estás midiendo clics e impresiones en lugar de citas. En esta categoría la conversión suele ser una llamada, y una campaña optimizada a clics optimiza el extremo equivocado.",
          "Pagas una iguala por actividad y no por resultados, con un reporte mensual lleno de alcance e interacciones y nada sobre pacientes.",
          "Gastas en captación mientras la tasa de inasistencia sigue intacta. Recuperar una cita existente es más barato que comprar una nueva, siempre.",
          "Subiste el presupuesto porque los resultados eran malos. Si el costo por consulta está por encima de lo que tu valor de paciente soporta, más volumen al mismo costo hace la pérdida más grande, no más chica.",
        ],
      },
    ],
    gradient: "from-neutral-800 to-zinc-950",
    faq: [
      {
        q: "¿Qué porcentaje de mis ingresos debo destinar a marketing?",
        qEn: "What percentage of revenue should I spend on marketing?",
        a: "El porcentaje es el marco equivocado para una clínica, porque ignora el valor del paciente y la capacidad disponible. Dos consultorios con los mismos ingresos pueden tener presupuestos correctos muy distintos si uno hace higiene y el otro rehabilitación con implantes. Calcula desde el hueco de capacidad y el valor de una consulta entrante.",
        aEn: "The percentage is the wrong frame for a clinic, because it ignores patient value and available capacity. Two practices with identical revenue can have very different correct budgets if one does hygiene and the other implant rehabilitation. Calculate from the capacity gap and the value of an enquiry.",
      },
      {
        q: "¿Cuánto debería costarme un paciente nuevo?",
        qEn: "How much should a new patient cost me?",
        a: "Lo que soporte tu valor de paciente y tu margen objetivo. Calcula el valor de un plan de tratamiento aceptado, multiplícalo por la proporción de consultas que llegan a aceptarse, y decide qué fracción de ese resultado estás dispuesto a pagar. Cualquier cifra de referencia externa ignora tu mezcla de tratamientos.",
        aEn: "Whatever your patient value and target margin support. Calculate the value of an accepted treatment plan, multiply by the share of enquiries that reach acceptance, and decide what fraction of that you are willing to pay. Any external benchmark ignores your treatment mix.",
      },
      {
        q: "¿Conviene contratar una agencia o hacerlo internamente?",
        qEn: "Should I hire an agency or do it in house?",
        a: "Depende de si el presupuesto justifica la iguala. Si tu hueco de capacidad es de pocos pacientes al mes, una iguala puede consumir la mayor parte del retorno posible y conviene empezar con el perfil de Google, la medición y el sitio. Cuando el hueco es grande y sostenido, la gestión profesional se paga.",
        aEn: "It depends on whether the budget justifies the retainer. If your capacity gap is a few patients a month, a retainer can consume most of the available return and it is better to start with the Google profile, measurement and the site. When the gap is large and sustained, professional management pays for itself.",
      },
      {
        q: "¿En cuánto tiempo debería ver resultados?",
        qEn: "How soon should I see results?",
        a: "Depende del canal. La publicidad de búsqueda captura demanda existente y produce llamadas en días, aunque estabilizar el costo por consulta toma semanas. El SEO local y el contenido tardan meses. Si mezclas ambos sin medir por separado, no vas a poder saber cuál funcionó.",
        aEn: "It depends on the channel. Search advertising captures existing demand and produces calls within days, though stabilising cost per enquiry takes weeks. Local SEO and content take months. If you mix both without measuring separately, you will not be able to tell which worked.",
      },
      {
        q: "¿Y si mi agenda ya está llena?",
        qEn: "What if my schedule is already full?",
        a: "Entonces marketing no es tu palanca. Con la capacidad al tope, gastar en captación produce listas de espera y pacientes irritados. Las palancas son el precio, la mezcla de tratamientos hacia casos de mayor valor, la eficiencia de agenda o agregar capacidad clínica.",
        aEn: "Then marketing is not your lever. At full capacity, spending on acquisition produces waiting lists and irritated patients. The levers are price, shifting treatment mix toward higher-value cases, scheduling efficiency, or adding clinical capacity.",
      },
      {
        q: "¿Vale la pena invertir si soy un consultorio de una sola persona?",
        qEn: "Is it worth investing if I am a single-practitioner practice?",
        a: "Sí, pero el orden cambia. Con capacidad limitada, el retorno está en los activos gratuitos y en la conversión: el Perfil de Empresa, las reseñas, un sitio que acredite tu cédula y una recepción que conteste. El gasto pagado tiene sentido cuando esos ya funcionan y sigue quedando hueco en la agenda.",
        aEn: "Yes, but the order changes. With limited capacity, the return is in free assets and conversion: the Business Profile, reviews, a site that shows your credential, and a front desk that answers. Paid spend makes sense once those work and there is still room in the schedule.",
      },
    ],
    schema: {
      keywords: [
        "medical marketing budget",
        "clinic marketing spend",
        "patient acquisition cost",
        "dental practice marketing",
      ],
      keywordsEs: [
        "cuanto invertir en marketing medico",
        "presupuesto marketing clinica",
        "costo por paciente nuevo",
        "marketing dental presupuesto",
      ],
    },
  },
  {
    ...
    categoryEs: "Marketing Médico",
    excerpt:
      "Nine failures we see repeatedly in Mexican practices, ordered by how much they cost. The expensive ones are not the ones clinics worry about.",
    excerptEs:
      "Nueve fallas que vemos una y otra vez en consultorios mexicanos, ordenadas por lo que cuestan. Las caras no son las que preocupan a las clínicas.",
    readingTime: 9,
    date: "2026-11-28",
    author: "Aphelion",
    authorRole: "Marketing Team",
    authorRoleEs: "Equipo de Marketing",
    lede: "Clinics tend to worry about the visible things: the logo, the colours, whether the Instagram grid looks consistent. The failures that actually cost patients are duller than that, and most of them happen after the marketing worked and before anyone gets treated.",
    ledeEs:
      "Las clínicas suelen preocuparse por lo visible: el logo, los colores, si la cuadrícula de Instagram se ve consistente. Las fallas que de verdad cuestan pacientes son más aburridas que eso, y casi todas ocurren después de que el marketing funcionó y antes de que alguien se atienda.",
    sections: [
      {
        id: "no-medir",
        heading: "Not knowing where patients come from",
        headingEs: "No saber de dónde vienen los pacientes",
        body: [
        ...
        bodyEs: [
          "Va primero porque vuelve adivinanza cualquier otra decisión, y porque es casi universal.",
          "Pregúntale a un consultorio qué canal produjo los pacientes nuevos del mes pasado y normalmente obtienes una impresión, no un conteo. Sin el conteo, las decisiones de presupuesto se toman según qué canal se discutió más recientemente.",
          "El arreglo no requiere software. Una columna en la agenda donde recepción anota cómo se enteró el paciente, preguntado al agendar y no en la visita, te lleva casi todo el camino. Agrega números de rastreo de llamadas cuando el volumen lo justifique.",
          "Pregunta al agendar, no en el sillón. Para cuando el paciente está siendo atendido ya se le olvidó, y va a decir que por recomendación porque se siente como la respuesta cortés.",
          "Haz esto dos meses antes de cambiar lo que gastas. Dos meses de atribución real valen más que un año de opinión.",
        ],
      },
      {
        id: "el-telefono",
        heading: "Buying calls nobody answers",
      ...
      {
        id: "inasistencias",
        heading: "Ignoring no-shows while buying new patients",
        headingEs: "Ignorar las inasistencias mientras compras pacientes nuevos",
        body: [
          "A no-show is a slot that was already sold and then evaporated. Recovering it is cheaper than acquiring a replacement by a wide margin, and almost nobody works on it.",
          "The mechanism is a confirmation when the appointment is made and a reminder the day before that the patient can respond to. The response is what matters, because a cancellation you learn about the day before is a slot you can refill.",
          "Clinics often make cancelling difficult on the theory that friction preserves appointments. It converts cancellations into no-shows instead, which is worse: you find out when the chair is empty and there is no time to fill it.",
          "This is also one of the few interventions in a clinic with a clean before-and-after number, which makes it satisfying to measure. The mechanics are in [WhatsApp para clínicas](/blog/whatsapp-para-clinicas).",
        ],
        bodyEs: [
      ...
      {
        id: "competir-por-precio",
        heading: "Competing on price in a trust purchase",
        headingEs: "Competir por precio en una compra de confianza",
        body: [
          "Discounting is the reflex when the schedule looks thin, and in this category it selects for the patient you want least.",
          "A patient who chose you because you were the cheapest leaves when someone cheaper appears, and they were never going to accept the larger treatment plan. Meanwhile the discount applies to the patients who would have paid full price anyway.",
          "It also fights the actual buying criterion. Nobody chooses a surgeon on price alone. They choose on confidence, and an aggressive discount on a medical service reads as a reason to wonder why.",
          "The alternative is not to be expensive and silent about it. Publish ranges with what determines them, so the patient can locate themselves before calling. That filters better than a discount does and it saves reception the calls that only ever ask the price.",
          "If you do run an offer, attach it to a first consultation or a diagnostic rather than to the treatment. It lowers the barrier to the conversation without devaluing the clinical work.",
        ],
        bodyEs: [
          "Descontar es el reflejo cuando la agenda se ve floja, y en esta categoría selecciona justo al paciente que menos quieres.",
          "Un paciente que te eligió por ser el más barato se va cuando aparece alguien más barato, y nunca iba a aceptar el plan de tratamiento grande. Mientras tanto el descuento se lo aplicas a los pacientes que iban a pagar precio completo de todos modos.",
          "También pelea contra el criterio real de compra. Nadie elige a un cirujano solo por precio. Eligen por confianza, y un descuento agresivo en un servicio médico se lee como una razón para preguntarse por qué.",
          "La alternativa no es ser caro y callado. Publica rangos con lo que los determina, para que el paciente pueda ubicarse antes de llamar. Eso filtra mejor que un descuento y le ahorra a recepción las llamadas que solo preguntan el precio.",
          "Si vas a hacer una oferta, amárrala a una primera consulta o a un diagnóstico, no al tratamiento. Baja la barrera a la conversación sin devaluar el trabajo clínico.",
        ],
      },
      {
        id: "reglas",
        heading: "Breaking rules nobody told them about",
        headingEs: "Romper reglas que nadie les dijo",
        body: [
          "Three of these appear constantly, and each one is described in a published rule the practice has never read.",
          "Review gating and incentives. Google's policy prohibits offering payment, discounts or free goods and services in exchange for a review, and prohibits discouraging negative reviews or selectively soliciting positive ones. A profile can be blocked from receiving new reviews for a period, or have existing ones unpublished. The compliant system is in [reseñas de Google para médicos](/blog/como-conseguir-resenas-google-medicos).",
        ...
        bodyEs: [
          ...
          "Review gating e incentivos. La política de Google prohíbe ofrecer pago, descuentos o bienes y servicios gratuitos a cambio de una reseña, y prohíbe desalentar reseñas negativas o solicitar selectivamente las positivas. Un perfil puede quedar bloqueado para recibir reseñas nuevas durante un periodo, o dejar de publicar las existentes. El sistema que cumple está en [reseñas de Google para médicos](/blog/como-conseguir-resenas-google-medicos).",
      ...
      {
        id: "sitio-folleto",
        heading: "A website that is a brochure",
        headingEs: "Un sitio que es un folleto",
        body: [
          "The typical clinic site has a home page, an about page, one services page listing everything in bullets, and a contact form.",
          "It ranks for the clinic's own name, which people only search once they already know it, and it answers none of the questions a comparing patient has.",
          "The corrections are structural rather than cosmetic. A page per procedure, because patients search by procedure and each carries different worries. Credentials visible rather than buried. Price ranges with what moves them. A booking path that works on a phone held in one hand.",
          "Redesigning the visual identity while leaving this structure intact is the most common way to spend money on a website and change nothing. The checklist is in [sitio web para clínicas](/blog/sitio-web-para-clinicas).",
        ],
        bodyEs: [
          "El sitio típico de una clínica tiene una portada, una página de nosotros, una de servicios que enlista todo en viñetas y un formulario de contacto.",
          "Posiciona para el nombre de la propia clínica, que la gente solo busca cuando ya la conoce, y no responde ninguna de las preguntas que tiene un paciente que compara.",
          "Las correcciones son estructurales, no cosméticas. Una página por procedimiento, porque los pacientes buscan por procedimiento y cada uno trae preocupaciones distintas. Credenciales visibles en lugar de enterradas. Rangos de precio con lo que los mueve. Una ruta de agendado que funcione en un teléfono sostenido con una mano.",
          "Rediseñar la identidad visual dejando esa estructura intacta es la forma más común de gastar dinero en un sitio y no cambiar nada. La lista está en [sitio web para clínicas](/blog/sitio-web-para-clinicas).",
        ],
      },
      {
        id: "hablar-como-clinico",
        heading: "Writing for colleagues instead of patients",
        headingEs: "Escribir para colegas en lugar de para pacientes",
        body: [
          "Clinical training produces precise vocabulary, and precise vocabulary is the wrong register for a page whose reader is frightened and searching in plain language.",
          "Patients do not search for periodontal disease, they search for bleeding gums. They do not search for endodontic treatment, they search for whether a root canal hurts. Writing in the technical term means the page does not appear for the search that exists.",
          "It is also a comprehension problem. A patient who does not fully understand the explanation does not ask; they leave and go somewhere the explanation was clearer, and they attribute the confusion to the procedure rather than the writing.",
          "The fix is to lead with the patient's term and introduce the clinical one alongside it. You lose nothing in accuracy and you become findable.",
          "Answer the questions asked in consultation, in the words they were asked in. That list is the best content brief a clinic has and it is free.",
        ],
        bodyEs: [
          "La formación clínica produce vocabulario preciso, y el vocabulario preciso es el registro equivocado para una página cuyo lector está asustado y busca en lenguaje llano.",
          "Los pacientes no buscan enfermedad periodontal, buscan encías que sangran. No buscan tratamiento endodóntico, buscan si duele una endodoncia. Escribir con el término técnico significa que la página no aparece para la búsqueda que sí existe.",
          "También es un problema de comprensión. Un paciente que no entiende bien la explicación no pregunta; se va a donde la explicación fue más clara, y atribuye la confusión al procedimiento y no a la redacción.",
          "El arreglo es abrir con el término del paciente e introducir el clínico junto a él. No pierdes nada de precisión y te vuelves localizable.",
          "Responde las preguntas que te hacen en consulta, con las palabras en que te las hicieron. Esa lista es el mejor brief de contenido que tiene una clínica y es gratis.",
        ],
      },
      {
        id: "abandonar",
      ...
      {
        id: "marketing-sobre-operacion",
        heading: "Fixing marketing when the problem is operations",
        headingEs: "Arreglar el marketing cuando el problema es la operación",
        body: [
          "The last one is the most expensive because the spending goes on for months before anyone questions the premise.",
          "If patients arrive and do not accept treatment plans, the problem is the consultation, not the campaign. If they accept and do not return, the problem is the experience. If the schedule is full and revenue is flat, the problem is pricing or treatment mix.",
          "In each of those cases more marketing pours volume into a system that is losing it somewhere else, and the loss scales with the spend.",
          "Before increasing a budget, check the sequence: enquiries, appointments booked, appointments attended, plans accepted, patients returning. The place where the number drops sharply is the bottleneck, and it is only sometimes the first one.",
          "This is the same reasoning behind working out a budget from capacity rather than from a percentage of revenue, which we set out in [cuánto invertir en marketing médico](/blog/cuanto-invertir-en-marketing-medico).",
        ],
        bodyEs: [
          "El último es el más caro porque el gasto sigue durante meses antes de que alguien cuestione la premisa.",
          "Si los pacientes llegan y no aceptan los planes de tratamiento, el problema es la consulta, no la campaña. Si aceptan y no regresan, el problema es la experiencia. Si la agenda está llena y los ingresos están planos, el problema es el precio o la mezcla de tratamientos.",
          "En cada uno de esos casos más marketing echa volumen a un sistema que lo está perdiendo en otro lado, y la pérdida escala con el gasto.",
          "Antes de subir un presupuesto, revisa la secuencia: consultas entrantes, citas agendadas, citas atendidas, planes aceptados, pacientes que regresan. El punto donde el número cae de golpe es el cuello de botella, y solo a veces es el primero.",
          "Es el mismo razonamiento detrás de calcular el presupuesto desde la capacidad y no desde un porcentaje de los ingresos, que planteamos en [cuánto invertir en marketing médico](/blog/cuanto-invertir-en-marketing-medico).",
        ],
      },
    ],
    gradient: "from-neutral-800 to-zinc-950",
    faq: [
      {
        q: "¿Cuál es el error más caro?",
        qEn: "Which mistake is the most expensive?",
        a: "Gastar en captación cuando el cuello de botella está en otro lado. Si los pacientes llegan y no aceptan tratamiento, o no regresan, más volumen amplifica la pérdida. Revisa la secuencia completa, de consulta entrante a paciente que regresa, y actúa donde el número cae de golpe.",
        aEn: "Spending on acquisition when the bottleneck is elsewhere. If patients arrive and do not accept treatment, or do not return, more volume amplifies the loss. Check the full sequence, from enquiry to returning patient, and act where the number drops sharply.",
      },
      {
        q: "¿Está mal ofrecer descuentos en tratamientos?",
        qEn: "Is it wrong to offer treatment discounts?",
        a: "No está prohibido, pero selecciona al paciente equivocado y se aplica sobre todo a quienes iban a pagar completo. En una compra de confianza, un descuento agresivo genera dudas. Si vas a hacer una oferta, ámarrala a la primera consulta o al diagnóstico, no al tratamiento.",
        aEn: "It is not prohibited, but it selects for the wrong patient and mostly applies to people who would have paid full price. In a trust purchase, an aggressive discount raises questions. If you run an offer, attach it to the first consultation or the diagnostic rather than the treatment.",
      },
      {
        q: "¿Cuánto tiempo debo darle a un canal antes de decidir?",
        qEn: "How long should I give a channel before deciding?",
        a: "Depende del canal y hay que fijarlo antes de empezar. La publicidad de búsqueda da llamadas rápido pero su costo por consulta tarda semanas en estabilizarse. El SEO local y el contenido tardan meses. Lo importante es escribir de antemano qué número te haría continuar.",
        aEn: "It depends on the channel and it should be set before starting. Search advertising produces calls quickly but its cost per enquiry takes weeks to stabilise. Local SEO and content take months. What matters is writing down in advance the number that would make you continue.",
      },
      {
        q: "¿Cómo sé si mi problema es marketing o recepción?",
        qEn: "How do I know if my problem is marketing or the front desk?",
        a: "Cuenta las llamadas perdidas y los mensajes sin responder durante una semana. Si recibes contactos suficientes y pocos se convierten en citas, el marketing está funcionando y la conversión no. Gastar más en anuncios en ese escenario echa más volumen por la misma fuga.",
        aEn: "Count missed calls and unanswered messages for one week. If you receive enough contacts and few become appointments, the marketing is working and the conversion is not. Spending more on ads in that scenario pours more volume through the same leak.",
      },
      {
        q: "¿Puedo publicar fotos de antes y después si no se ve la cara?",
        qEn: "Can I post before and after photos if the face is not visible?",
        a: "Sigues necesitando autorización por escrito. La NOM-004-SSA3-2012 exige la autorización escrita del paciente y además medidas para que no pueda ser identificado, así que son dos requisitos. En una ciudad chica, una boca recortada con una disposición dental distintiva puede seguir identificando a alguien.",
        aEn: "You still need written authorisation. NOM-004-SSA3-2012 requires the patient's written authorisation and also measures preventing identification, so there are two requirements. In a small city, a cropped mouth with a distinctive dental arrangement can still identify someone.",
      },
    ],
    schema: {
      keywords: [
        "dental marketing mistakes",
        "medical practice marketing errors",
        "clinic patient acquisition",
        "healthcare marketing pitfalls",
      ],
      keywordsEs: [
        "errores marketing dental",
        "errores marketing medico",
